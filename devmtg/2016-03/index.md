...
      [ARM](http://www.arm.com), [HSA Foundation](http://www.hsafoundation.com), [Google](http://www.google.com), [Intel](http://www.intel.com), [Codeplay](http://www.codeplay.com/), [Microsoft](http://www.microsoft.com/en-us/), [Microsoft Research](http://research.microsoft.com/en-us/)  
**

The hacker's lab & networking session is sponsored by [**Solid Sands**](http://www.solidsands.nl/)

1.  [About](#about)
2.  [Schedule](#schedule)
3.  [Slides & Videos](#SlidesAndVideos)
4.  [Presentations abstracts](#PresentationsAbstracts)
5.  [Tutorials abstracts](#TutorialsAbstracts)
6.  [Lightning talks abstracts](#LightningTalksAbstracts)
7.  [Posters abstracts](#PostersAbstracts)
8.  [BoFs abstracts](#BoFsAbstracts)

*   **What**: The sixth European LLVM meeting
*   **When**: March 17-18, 2016
*   **Where**: [Hotel Princesa Sofia](http://www.princesasofia.com/en), Barcelona, Spain
...
This year, the conference will be collocated with [CGO](http://cgo.org/cgo2016/) and [CC](http://cc2016.eew.technion.ac.il/), enabling collaboration and exchange of ideas with the research community.
...
You may also contact the organizer: [Vladimir Subotic](mailto:vladimir.subotic@bsc.es)

<!-- <div class="www_sectiontitle" id="CFP">Call for Paper</div> <p> We invite academic, industrial and hobbyist speakers to present their work on developing or using LLVM, Clang, etc. Proposals for technical presentations, posters, workshops, demonstrations and BoFs are welcome. Material will be chosen to cover a broad spectrum of themes and topics at various depths, some technical deep-diving, some more community focused. </p> <p> We are looking for: </p> <ul> <li>Keynote speakers.</li> <li>Technical presentations (30 minutes plus questions and discussion) related to the development of LLVM, Clang, LLD, LLDB, Polly, ...</li> <li>Presentations relating to academic or commercial use of LLVM, Clang etc.</li> <li>Lightning talks (5 minutes, no questions, no discussion).</li> <li>Workshops and in-depth tutorials (1-2 hours - please specify in your submission).</li> <li>Poster presentations.</li> <li>Birds of a Feather sessions (BoFs).</li> </ul> <p> The deadline for receiving submissions is &lt;del&gt;January 25, 2016&lt;/del&gt; &lt;ins&gt;January 29, 2016&lt;/ins&gt;. </p> <p> Submissions should be done using the <a href="https://easychair.org/conferences/?conf=eurollvm2016"> Easychair</a> platform. </p> <p> Please note that presentation materials and videos for the technical sessions will be posted on llvm.org after the conference. We have reserved additional spots for speakers, such that they can attend the conference even though we have reached our registration limit. </p> <p> In terms of submission style, we are looking for: </p> <ul> <li>A title and an extended abstract,</li> </ul> <p> OR </p> <ul> <li>A title, abstract and slides.</li> </ul> <p> Please make clear the status of the slides (are they a skeleton of your presentation with the detail missing ?), or, perhaps a section of detail that lacks introduction and conclusions?  Also make sure to give enough information in the extended abstract: the more you can give us and tell us the easier it will be for us to be positive about your submission.  </p> <p> Proposals that are not sufficiently detailed (talks lacking a comprehensive abstract for example) are likely to be rejected. Slides and posters must be in PDF format. </p> <p> The call for paper is over since January 29, 2016. </p> <p> The program committee is now working hard at reviewing all submissions. </p> <p> The program committee attempts to reflects the diversity of our community. It consists of David Chisnall, Sanjoy Das, Tobias Edler von Koch, Arnaud de Grandmaison, Hal Finkel, Renato Golin, Tobias Grosser, Tanya Lattner, David Majnemer, James Molloy, Adam Nemet. </p> <p> Speakers will be notified of acceptance or rejection by February 15th, 2016. </p> -->

# Schedule

The schedule may be found here: [https://2016europeanllvmdevelopersmeetin.sched.org](https://2016europeanllvmdevelopersmeetin.sched.org)

# Slides & Videos

| Media | Talk / Presenter(s) |
| --- | --- |
| [**Slides**](Presentations/Clang-LibCPlusPlus-CPlusPlusStandard.pdf)<br>[**Video**](https://youtu.be/zQ9tT8fbtSo) | **[Clang, libc++ and the C++ standard](#presentation1)**<br>*Marshall Clow - Qualcomm*<br>*Richard Smith - Google* |
| [**Slides**](Presentations/CodeletExtractorAndREplayer.pdf)<br>[**Video**](https://youtu.be/7sVnjJlZTW4) | **[Codelet Extractor and REplayer](#presentation2)**<br>*Chadi Akel - Exascale Computing Research* |
| [**Slides**](&lt;Presentations/EuroLLVM 2016- New LLD linker for ELF.pdf&gt;)<br>[**Video**](https://youtu.be/CYCRqjVa6l4) | **[New LLD linker for ELF](#presentation3)**<br>*Rui Ueyama - Google* |
| [**Slides**](Presentations/X86CodeSizePDF.pdf)<br>[**Video**](https://youtu.be/yHexQSFud3w) | **[Improving LLVM Generated Code Size for X86 Processors](#presentation4)**<br>*David Kreitzer - Intel*<br>*Zia Ansari - Intel* |
| [**Slides**](Presentations/Beyls2016_AmelioratingMeasurmentBias.pdf)<br>[**Video**](https://youtu.be/COmfRpnujF8) | **[Towards ameliorating measurement bias in evaluating performance of generated code](#presentation5)**<br>*Kristof Beyls - ARM* |
| [**Slides**](Presentations/AnastasiaStulova_OpenCL20_EuroLLVM2016.pdf)<br>[**Video**](https://youtu.be/3yzL2loPtgM) | **[A journey of OpenCL 2.0 development in Clang](#presentation6)**<br>*Anastasia Stulova - ARM* |
| [**Slides**](Presentations/BOLT_EuroLLVM_2016.pdf)<br>[**Video**](https://youtu.be/gw3iDO3By5Y) | **[Building a binary optimizer with LLVM](#presentation7)**<br>*Maksim Panchenko - Facebook* |
| [**Slides**](Presentations/SVF_EUROLLVM2016.pdf)<br>[**Video**](https://youtu.be/nD-i-enA8rc) | **[SVF: Static Value-Flow Analysis in LLVM](#presentation8)**<br>*Yulei Sui - University of New South Wales* |
| [**Slides**](Presentations/EuroLLVM_ChrisDiamand.pdf)<br>[**Video**](https://youtu.be/duoA1eWwE0E) | **[Run-time type checking with clang, using libcrunch](#presentation9)**<br>*Chris Diamand - University of Cambridge* |
| [**Slides**](Presentations/Molly.pdf)<br>[**Video**](https://youtu.be/fKW3yjhcrh0) | **[Molly: Parallelizing for Distributed Memory using LLVM](#presentation10)**<br>*Michael Kruse - INRIA/ENS* |
| [**Slides**](Presentations/polly-gpu-eurollvm.pdf)<br>[**Video**](https://youtu.be/MOX4TxRIijg) | **[How Polyhedral Modeling enables compilation to Heterogeneous Hardware](#presentation11)**<br>*Tobias Grosser - ETH* |
| [**Slides**](Presentations/EuroLLVM2016-E.Crawford_and_L.Drummond-Bringing_RenderScript_to_LLDB.pdf)<br>[**Video**](https://youtu.be/BBC61L0QKCM) | **[Bringing RenderScript to LLDB](#presentation12)**<br>*Luke Drummond - Codeplay*<br>*Ewan Crawford - Codeplay* |
| [**Slides**](Presentations/Offload-EuroLLVM2016.pdf)<br>[**Video**](https://youtu.be/YKX6EMEib4g) | **[C++ on Accelerators: Supporting Single-Source SYCL and HSA Programming Models Using Clang](#presentation13)**<br>*Victor Lomuller - Codeplay* |
| [**Slides**](Presentations/eurollvm-2016-arm-code-size.pdf)<br>[**Video**](https://youtu.be/cFgwEEBw7U0) | **[A closer look at ARM code size](#presentation14)**<br>*Tilmann Scheller - Samsung Electronics* |
| [**Slides**](Presentations/Barcelona2016report.pdf)<br>[**Video**](https://youtu.be/2YSzLyBO4yM) | **[Scalarization across threads](#presentation15)**<br>*Alexander Timofeev - Luxoft* |
| [**Slides**](Tutorials/LLDB-tutorial.pdf)<br>[**Video**](https://youtu.be/9hhDZeV0fYU) | **[LLDB Tutorial: Adding debugger support for your target](#tuto1)**<br>*Deepak Panickal - Codeplay*<br>*Andrzej Warzynski - Codeplay* |
| [**Slides**](Tutorials/applied-polyhedral-compilation.pdf)<br>[**Video**](https://youtu.be/mXve_W4XU2g) | **[Analyzing and Optimizing your Loops with Polly](#tuto2)**<br>*Tobias Grosser - ETH*<br>*Johannes Doerfert - Saarland University* |
| [**Slides**](Tutorials/Tutorial.pdf)<br>[**Video**](https://youtu.be/Z5KcwVaak3s) | **[Building, Testing and Debugging a Simple out-of-tree LLVM Pass](#tuto3)**<br>*Serge Guelton - Quarkslab*<br>*Adrien Guinet - Quarkslab* |
| [**Video**](https://youtu.be/TkanbGAG_Fo) | **[Lightning talks](#LightningTalksAbstracts)** |
...
[**Slides**](Presentations/Clang-LibCPlusPlus-CPlusPlusStandard.pdf) [**Video**](https://youtu.be/zQ9tT8fbtSo)  
...
[**Slides**](Presentations/CodeletExtractorAndREplayer.pdf) [**Video**](https://youtu.be/7sVnjJlZTW4)  
...
*Rui Ueyama - Google*  
[**Slides**](&lt;Presentations/EuroLLVM 2016- New LLD linker for ELF.pdf&gt;) [**Video**](https://youtu.be/CYCRqjVa6l4)  
...
[**Slides**](Presentations/X86CodeSizePDF.pdf) [**Video**](https://youtu.be/yHexQSFud3w)  
...
*Kristof Beyls - ARM*  
[**Slides**](Presentations/Beyls2016_AmelioratingMeasurmentBias.pdf) [**Video**](https://youtu.be/COmfRpnujF8)  
...
[**Slides**](Presentations/AnastasiaStulova_OpenCL20_EuroLLVM2016.pdf) [**Video**](https://youtu.be/3yzL2loPtgM)  
...
[**Slides**](Presentations/EuroLLVM_ChrisDiamand.pdf) [**Video**](https://youtu.be/duoA1eWwE0E)  
...
[**Slides**](Presentations/Molly.pdf) [**Video**](https://youtu.be/fKW3yjhcrh0)  
...
*Tobias Grosser - ETH*  
[**Slides**](Presentations/polly-gpu-eurollvm.pdf) [**Video**](https://youtu.be/MOX4TxRIijg)  
...
[**Slides**](Presentations/EuroLLVM2016-E.Crawford_and_L.Drummond-Bringing_RenderScript_to_LLDB.pdf) [**Video**](https://youtu.be/BBC61L0QKCM)  
...
[**Slides**](Presentations/Offload-EuroLLVM2016.pdf) [**Video**](https://youtu.be/YKX6EMEib4g)  
...
[**Slides**](Presentations/eurollvm-2016-arm-code-size.pdf) [**Video**](https://youtu.be/cFgwEEBw7U0)  
...
[**Slides**](Presentations/Barcelona2016report.pdf) [**Video**](https://youtu.be/2YSzLyBO4yM)  
...
[**Slides**](Tutorials/LLDB-tutorial.pdf) [**Video**](https://youtu.be/9hhDZeV0fYU)  
...
[**Slides**](Tutorials/applied-polyhedral-compilation.pdf) [**Video**](https://youtu.be/mXve_W4XU2g)  
...
[**Slides**](Tutorials/Tutorial.pdf) [**Video**](https://youtu.be/Z5KcwVaak3s)  
...
[**Video**](https://youtu.be/TkanbGAG_Fo) for all lightning talks.  

**Random Testing of the LLVM Code Generator**  
*Bevin Hansson - SICS Swedish ICT*  
[**Slides**](Lightning-Talks/RandomTestingOfTheLLVMCodeGenerator.pdf)  
...
[**Slides**](Lightning-Talks/Archer_talk-EuroLLVM-2016.pdf)  
...
Note: this lightning has an associated [poster](#poster1)

**Hierarchical Graph Coloring Register Allocation in LLVM**  
*Aaron Smith - Microsoft Research*  
[**Slides**](Lightning-Talks/HierarchicalGraphColoringRegAlloc-asmith.pdf)  
...
*Aaron Smith - Microsoft Research*  
[**Slides**](Lightning-Talks/RetargetingLLVMToEDGEArchitecture-asmith.pdf)  
...
[**Slides**](Lightning-Talks/unison.pdf)  
...
[**Slides**](Lightning-Talks/miletic-gromacs-amdgpu.pdf)  
...
[**Slides**](Lightning-Talks/EuroLLVM_2016_paper_22.pdf)  
...
Note: this poster has an associated [lightning talk](#lightning2)
...
[**BoF notes**](BoF-Minutes/LLVMFoundation.pdf)  
...
[**BoF notes**](BoF-Minutes/CompilersInEducation.pdf)  
...
[**BoF notes**](BoF-Minutes/SurvivingDowntream.pdf)  
...
*Johannes Doerfert - Saarland University*  
*Zino Benaissa - Quic Inc.*  
[**BoF notes**](BoF-Minutes/PollyLoopOptimizationInfrastructure.pdf)  
...
*Ulrich Weigand - IBM*  
[**BoF notes**](BoF-Minutes/PowerPCAndSystemZ.pdf)  
...
*David Chisnall - Computer Laboratory, University of Cambridge*  
[**BoF notes**](BoF-Minutes/HowToMakeLLVMMoreFriendly.pdf)  
