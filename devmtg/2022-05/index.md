...
1.  [About](#about)
2.  [Event Site](https://llvm.swoogo.com/2022eurollvm/)
3.  [Program (Videos & Slides)](#program)
4.  [Code of Conduct](#coc)
5.  [Contact](#contact)

*   **Conference Dates**: May 10-11, 2022
*   **Location**: [Park Plaza London Riverbank](https://www.parkplazariverbank.com) - London, UK
*   **[Registration](https://llvm.swoogo.com/2022eurollvm/begin)**
...
To see the agenda, speakers, and register, please visit the [Event Site](https://llvm.swoogo.com/2022eurollvm/).
...
For future announcements or questions, please ask on the LLVM Discourse forums in the [Community - EuroLLVM category](https://discourse.llvm.org/c/community/eurollvm/22).

# Program (Slides & Videos)

**Keynotes**

MCA Daemon: Hybrid Throughput Analysis Beyond Basic Blocks \[ [Video](https://youtu.be/ZGEP7JEIKNo) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-MCA-Deamon.pdf) \]  
...
Finding Missed Optimizations Through the Lens of Dead Code Elimination \[ [Video](https://youtu.be/jD0WDB5bFPo) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-FindingMissedOptimizations.pdf) \]  
...
Precise Polyhedral Analyses For MLIR using the FPL Presburger Library \[ [Video](https://youtu.be/Xg4RfgPIT-Y) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-PrecisePolyhedralAnalysesForMLIR.pdf) \]  
...
Prototyping a Compiler for Homomorphic Encryption Using MLIR \[ [Video](https://youtu.be/QyxiqmO6_qQ) \] \[ Slides \]  
...
Lightweight Instrumentation using Debug Information \[ [Video](https://youtu.be/vFWwJrOiVMM) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-LightweightInstrumentationUsingDebugInformation.pdf) \]  
...
Custom benefit-driven inliner in Falcon JIT \[ [Video](https://youtu.be/UfA3VlByloU) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-CustomBenefitDrivenInliner-in-FalconJIT.pdf) \]  
...
LLD for Mach-O: The Journey \[ [Videos](https://youtu.be/ynbFTojAOiY) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-LLD-for-Mach-O.pdf) \]  
*Jez Ng, Meta*  
...
How to write a new compiler driver? The LLVM Flang perspective. \[ [Video](https://youtu.be/OvTiKWfhaho) \] \[ Slides \]  
...
Developing an LLVM backend for the KV3 Kalray VLIW core \[ [Videos](https://youtu.be/4Xad8NDRYDI) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-DevelopingAnLLVMBackend-for-the-KV3KalrayVLIWCore.pdf) \]  
*Cyril Six, Kalray*  
...
Hardware loops in the IPU backend \[ [Videos](https://youtu.be/jZlGY4Eu314) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-HardwareLoops-in-the-IPUBackend.pdf) \]  
...
Experiences of OS distributions using LLVM as their main toolchain \[ [Videos](https://youtu.be/h9xg8Y8byIg) \] \[ Slides \]  
...
Faust audio Domain Specific Language and LLVM \[ [Videos](https://youtu.be/LVtH3BlMG0Y) \] \[ Slides \]  
*Stéphane Letz, GRAME*  
...
Implicitly discovered, explicitly built Clang modules \[ [Videos](https://youtu.be/W5kjEeSmCBU) \] \[ Slides \]  
*Jan Svoboda, Apple*  
...
Introduction to the IPU graph compiler and the use of LLVM \[ [Videos](https://youtu.be/nr2ibjPg7bc) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-Introduction-to-the-IPUGraphCompiler-and-the-use-of-LLVM.pdf) \]  
...
ez-clang C++ REPL for bare metal embedded devices \[ [Videos](https://youtu.be/_qYqEYh1nHE) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-ezClang.pdf) \]  
*Stefan Gränitz*  
...
SCEV-Based debuginfo salvaging in Loop Strength Reduction \[ [Videos](https://youtu.be/aok7taVFUWQ) \] \[ Slides \]  
...
How to Make Hardware with Maths: An Introduction to CIRCT's Scheduling Infrastructure \[ [Video](https://youtu.be/tctEk7O5DU0) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-HowtoMakeHardwarewithMaths.pdf) \]  
...
Improving debug locations for variables in memory \[ [Video](https://youtu.be/wSmveKsWSSY) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-ImprovingDebugLocations-for-Variables-in-Memory.pdf) \]  
...
LLVM-MOS 6502 Backend: Having a Blast in the Past \[ [Video](https://youtu.be/2lW3WHPtmKo) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-LLVM-MOS-6502Backend.pdf) \]  
...
LLVM office hours: addressing LLVM engagement and contribution barriers \[ [Video](https://youtu.be/xp7yQTIyxkw) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-OfficeHours.pdf) \]  
*Kristof Beyls, Arm*  
...
llsoftsecbook: an open source book on low-level software security for compiler developers \[ [Video](https://youtu.be/GeGvkrkHrh8) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-llsoftsecbook.pdf) \]  
*Kristof Beyls, Arm*  
...
Exploring Clang/LLVM optimization on programming horror \[ [Video](https://youtu.be/21qjU6ml7vk) \] \[ Slides \]  
*Matthieu Dubet*  

Exploring how Clang/LLVM manages to transform a linear time complexity algorithm to a constant time one.

Flang update \[ [Video](https://youtu.be/FoIjafZGDdE) \] \[ Slides \]  
...
Using link-time call graph embedding to streamline compiler-assisted instrumentation selection \[ [Video](https://youtu.be/I5DaDeF7cmI) \] \[ Slides \]  
...
Automated Batching and Differentiation of Scalar Code in Enzyme \[ [Video](https://youtu.be/edvaLAL5RqU) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-AutomatedBatchingandDifferentiationofScalarCodeinEnzyme.pdf) \]  
...
Extending Sulong (an LLVM bitcode runtime) for cross-language interoperability between C++/Swift and Java, JavaScript or Python \[ [Video](https://youtu.be/Z0imCJmfMAk) \] \[ [Slides](https://llvm.org/devmtg/2022-05/slides/2022EuroLLVM-ExtendingSulong.pdf) \]  
