...
*   **Conference Dates**: October 23-24, 2024 (Pre-Conference workshops October 22)
*   **Location**: [Santa Clara Marriott, Santa Clara, CA](https://www.marriott.com/en-us/hotels/sjcga-santa-clara-marriott/overview/?scid=f2ae0541-1279-4f24-b197-a979c79310b0)
*   **Event Site: [https://llvm.swoogo.com/2024devmtg](https://llvm.swoogo.com/2024devmtg)
    ...
    **Keynotes:**
    ...
    Rust ❤️ LLVM  
    *Nikita Popov* \[ [Video](https://youtu.be/Kqz-umsAnk8) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/keynote/Popov-Rust_Heart_LLVM.pdf) \]  
    ...
    *Aaron Ballman* \[ [Video](https://youtu.be/hKY7OLLZw1w) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/keynote/Ballman-StateofClang2024.pdf) \]  
    ...
    *Alex Zinenko* \[ [Video](https://youtu.be/E2xLXcrkOTE) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/tutorial/Zinenko-UsingMLIR-from-C-and-Python.pdf) \]  
    ...
    *Tom Stellard* \[ [Video](https://youtu.be/eBHgcsz-HPg) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/tutorial/Stellard-SupplyChainSecurity.pdf) \]  
    ...
    *Alex MacLean, Justin Fargnoli* \[ [Video](https://youtu.be/nNQ6AF6i5FI) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/tutorial/MacLean-Fargnoli-ABeginnersGuide-to-SelectionDAG.pdf) \]  
    SelectionDAG is a crucial framework within LLVM for lowering LLVM IR into efficient machine code. However, little beginner-friendly documentation exists for it. This talk fills that void by covering the framework's architecture, target-specific optimizations, and integration with LLVM IR and Machine IR. By the end of the session, participants will be well-prepared to make their first contributions to backends using the SelectionDAG framework.

    Support a new Calling Convention in LLVM  
    *Brandon Wu* \[ [Video](https://youtu.be/6ZaiFA8eyHk) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/tutorial/Wu-Support-a-NewCallingConvention.pdf) \]  
    ...
    *Alex Zinenko, Stella Laurenzo, Renato Golin, Tobias Grosser, Mehdi Amini, Chris Lattner* \[ [Video](https://youtu.be/T5H1HjOSE_I) \]  
    ...
    *Petr Hosek* \[ [Video](https://youtu.be/5hHQi-Uj34I) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Hosek-ModernEmbeddedDevelopment-with-LLVM.pdf) \]  
    Modern day embedded development is anything but modern. I believe that we can change the way embedded development is done by using a modern toolchain based on LLVM and adopting practices that have become commonplace for C/C++ user-space software development. In this talk, I will cover our experience from migrating several internal and external baremetal projects to the Clang toolchain, the issues we encountered and the opportunities we discovered.

    What we learned from building Mojo’s optimization pipeline  
    *Weiwei Chen* \[ [Video](https://youtu.be/yuSBEXkjfEA) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Weiwei-What-We-Learned-Building-Mojo-OptimizationPipeline.pdf) \]  
    ...
    *Joshua Cranmer* \[ [Video](https://youtu.be/sSNAGFXNXYU) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Cranmer-FloatingPoint-in-LLVM.pdf) \]  
    This talk will cover the current state of semantics in floating-point for LLVM: the things that work, the things that don't work, and the things that are just plain missing entirely.

    Higher-Level Linker Scripts for Embedded Systems  
    *Daniel Thornburgh* \[ [Video](https://youtu.be/t-lvIFmggmA) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Thornburgh-Higher-LevelLinkerScripts-forEmbeddedSystems.pdf) \]  
    ...
    *Andy Kaylor* \[ [Video](https://youtu.be/3Uf_3Su1NEc) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Kaylor-Towards-Useful-Fast-Math.pdf) \]  
    Fast-math semantic modes provide a way to selectively relax the default rules for numeric consistency used by the compiler. Relaxing these rules can improve performance, but it can also introduce accuracy errors. This talk will describe a technique to track down the cause of such errors and introduce a proposal for new LLVM optimizer infrastructure to make the debugging process easier.

    LLVM libc math library - Current status and future directions  
    *Tue Ly* \[ [Video](https://youtu.be/-8zb8rHbvcQ) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Ly-LLVM-libc-math-library-CurrentStatus.pdf) \]  
    ...
    *Bea Healy, Luisa Cicolini* \[ [Video](https://youtu.be/ga0VHhwmKMM) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Healy-Cicolini-ExploitingMLIR-Abstractions-for-HardwareVerification.pdf) \]  
    ...
    *Michal Paszkowski, Vyacheslav Levytskyy* \[ [Video](https://youtu.be/oLuTsD4mLXE) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Paszkowski-Levytskyy-AdvancingSPIR-V-BackendStability.pdf) \]  
    ...
    *Min Hsu* \[ [Video](https://youtu.be/h2tDWoTWUnw) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Hsu-RVV-Exegesis.pdf) \]  
    ...
    Loop Vectorisation: a quantitative approach to identify/evaluate opportunities  
    *Sjoerd Meijer* \[ [Video](https://youtu.be/u7W3_xL_3NQ) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Meijer-Loop-Vectorisation.pdf) \]  
    ...
    *Ravi Narayanaswamy* \[ [Video](https://youtu.be/4Qof7vtfhuk) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Narayanaswamy-EnhanceSYCL-offloading-support.pdf) \]  
    ...
    *Steffi Stumpos* \[ [Video](https://youtu.be/ILjuvj13EpQ) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Stumpos-EfficientCoroutineImplementatio-inMLIR.pdf) \]  
    ...
    *Lucile Rose Nihlen* \[ [Video](https://youtu.be/CLczt-RJzAA) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Nihlen-LLVM-Premerge-Testing.pdf) \]  
    ...
    *Shubham Rastogi* \[ [Video](https://youtu.be/c629Cggdes4) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Rastogi-Fine-grained-compilation-caching-using-llvm-cas.pdf) \]  
    ...
    *Tom Stellard, David Edelsohn* \[ [Video](https://youtu.be/HwrQyOQBIpQ) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Edelsohn-GCC-and-LLVMDevelopment-and-Maintenance.pdf) \]  
    LLVM and GCC have evolved very different policies for release engineering (development cycle, scheduling, type of maintenance, duration of maintenance) that impacts the manner in which it is consumed and deployed by individual users, packagers (Linux distributions and product-versions of the compilers), and downstream projects. This session explores the differing approaches and if either compiler should consider changes in its policies to better address the needs of its user community or to make the development and release engineering process more efficient. The session will describe the release engineering process of the two compiler ecosystems followed by a conversation among the attendees about potential paths forward.

    Two Compilers, One Language, No Specification  
    *Chris Bieneman* \[ [Video](https://youtu.be/sVq5khCXkbw) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Bieneman-Two-Compilers-One-Language-NoSpecification.pdf) \]  
    The High Level Shader Language (HLSL) is a popular cross-platform programming language for GPUs focused on realtime graphics applications. Through its over 20 year life HLSL has had two reference compilers, but no specification. As HLSL support in Clang progresses, the implementers are working through challenges caused by the lack of a specification and the language inconsistencies between the reference implementations.
    ...
    *Mehdi Amini, Fabian Mora Cordero* \[ [Video](https://youtu.be/Bt__BDQivxo) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Amini-Cordero-MakingUpstreamMLIRMoreFriendly.pdf) \]  
    ...
    *Michael Jones, Christopher Di Bella* \[ [Video](https://youtu.be/VAEO86YtTHA) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Jones-DiBella-hand-in-hand.pdf) \]  
    Have you ever wondered how libc++ implements functions that are similar to libc? For example, consider std::from\_chars(float) and strtof. They both take a string and output a float, but from\_chars also takes an end pointer and a format argument. They operate similarly behind the scenes. Their interfaces mean that from\_chars can’t easily be implemented in terms of strtof. This talk will explain Project Hand-In-Hand, an LLVM-libc and libc++ collaboration to share the internal code for very similar functions that have incompatible interfaces.

    Challenges in Using LLVM as a Quantum Intermediate Representation  
    *Andrew Litteken* \[ [Video](https://youtu.be/lzl-qdswIgU) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Litteken-Challenges-Using-LLVM-as-a-QuantumIntermediate-Representation.pdf) \]  
    The most efficient programming and compilation paradigms for quantum computing are still being explored as new applications and architectures are developed. This talk lays out several challenges of performing quantum compilation, and how the Intel Quantum Compiler meets the requirements of quantum computation by using the LLVM infrastructure. Additionally, we will discuss how the Intel Quantum Compiler makes the quantum intermediate representation more approachable to users who are not familiar with compiler infrastructure including the Function Language Extension for Quantum (FLEQ) and Quantum Circuit Object framework.

    (Offload) ASAN via Software Managed Virtual Memory  
    *Johannes Doerfert* \[ [Video](https://youtu.be/B60jp4khrvc) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Doerfert-Offload-ASAN.pdf) \]  
    ...
    *Joseph Huber* \[ [Video](https://youtu.be/4TxGWis1mws) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Huber-A-CPlusPlus-Toolchain-for-Your-GPU.pdf) \]  
    ...
    *Manuel Drehwald* \[ [Video](https://youtu.be/xEcoNuzhfBI) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Drehwald-AutomaticDifferentiation-in-Rust.pdf) \]  
    ...
    *Timm Baeder* \[ [Video](https://youtu.be/eMT1dBlaggQ) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Baeder-A-new-constant-expression-interpreter-for-Clang.pdf) \]  
    ...
    *Richard Smith* \[ [Video](https://youtu.be/j0BL52NdjAU) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Smith-Generic-implementation-strategies-in-Carbon-and-Clang.pdf) \]  
    A dive into the generics implementation in the Carbon toolchain and the templates implementation in Clang. This talk will contrast the approaches taken and discuss some benefits of each direction.

    JSIR - Adversarial JavaScript Detection With MLIR  
    *Zhixun Tan* \[ [Video](https://youtu.be/SY1ft5EXI3I) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Tan-JSIR.pdf) \]  
    ...
    *Michael Spencer, Ian Anderson* \[ [Video](https://youtu.be/tcB1vXc4L8M) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Anderson-Spencer-ClangModules-at-Scale.pdf) \]  
    ...
    *Bart Chrzaszcz, Zixuan Jiang* \[ [Video](https://youtu.be/po-Cxq2Acig) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Chrzaszcz-Jiang-Shardy.pdf) \]  
    ...
    *Artem Chikin* \[ [Video](https://youtu.be/DEjbcVRfSKA) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Chikin-Swift-Explicitly-Built-Modules.pdf) \]  
    ...
    *Ahmed Taei* \[ [Video](https://youtu.be/sOZWhPVvRdw) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Taei-Simplifying-GPU-Programming-with-Parametric-Tile-Level-Tensors-In-Mojo.pdf) \]  
    ...
    *Alex Keizer, Siddharth Bhat* \[ [Video](https://youtu.be/4lh2NnLOxvQ) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Keizer-Bhat-lean-mlir.pdf) \]  
    ...
    *Orlando Cazalet-Hyams* \[ [Video](https://youtu.be/yj1EUzXVP1I) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Cazalet-Hyams-Improving-optimized-code-line-table-quality.pdf) \]  
    ...
    *Evan Ovadia* \[ [Video](https://youtu.be/IpuvQUVB8Cg) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Ovadia-LinearTypes-in-Vale-and-Mojo.pdf) \]  
    ...
    *Anton Korobeynikov* \[ [Video](https://youtu.be/bytWm7BzJVE) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Korobeynikov-Adding-Pointer-Authentication-ABI-support.pdf) \]  
    ...
    *Alexandre Ganea, Francisco Cabrita* \[ [Video](https://youtu.be/1Gi9nPVUZro) \] \[ Slides\]  
    ...
    *Oliver Hunt* \[ [Video](https://youtu.be/GGGaiGpm5BY) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/techtalk/Hunt-Mitigating-use-after-free-security-vulnerabilities.pdf) \]  
    ...
    *Nicolas Celik* \[ [Video](https://youtu.be/H6aOFSVwSSM) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/studenttalks/Celik-Half-precision-in-LLVM-libc.pdf) \]  
    ...
    *Arjun Pitchanathan* \[ [Video](https://youtu.be/eFMTHtS3y1U) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/studenttalks/Pitchanathan-DynamicAPInt-Infinite-PrecisionArithmetic-for-LLVM.pdf) \]  
    ...
    *Siyuan Brant Qian* \[ [Video](https://youtu.be/b0COW_6v4m0) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/studenttalks/Qian-FPOpt.pdf) \]  
    ...
    *Emil Pedersen* \[ [Video](https://youtu.be/zluvVkxK6oY) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/studenttalks/Pedersen-DataDrivenApproachToDebugInfoQuality.pdf) \]  
    ...
    *Jiahan Xie* \[ [Video](https://youtu.be/nOcMt7JdIkg) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/studenttalks/Xie-GISel.pdf) \]  
    ...
    *Fabian Mora-Cordero* \[ [Video](https://youtu.be/b9jprrQjmq4) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/studenttalks/Cordero-The-syntax-dialect.pdf) \]  
    ...
    *Corbin Robeck* \[ [Video](https://youtu.be/raZR06JgeEc) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Robeck-Instrumenting-MLIR-Based-ML-Compilers.pdf) \]  
    ...
    *Kai Ting Wang* \[ [Video](https://youtu.be/iYLxgTRe8TU) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Wang-PyDSL.pdf) \]  
    ...
    *Lorenzo Chelini* \[ [Video](https://youtu.be/ikI0vUhC_qA) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Chelini-EmbeddingDomain-SpecifcLanguagesWithPolygiest.pdf) \]  
    ...
    *Sumukh Bharadwaj, Raghesh Aloor* \[ [Video](https://youtu.be/gDT1dPYZ0Qc) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Bharadwaj-Aloor-Vector-DDG.pdf) \]  
    ...
    *Madhur Amilkanthwar* \[ [Video](https://youtu.be/PuuSsAOAf38) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Amilkanthwar-Towards-Better-GlobalISel-Performance-On-AArch64) \]  
    ...
    *Charitha Saumya, Jianhui Li* \[ [Video](https://youtu.be/amLHnkSD1zc) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Saumya-Li-Extending-MLIR-Dialects-for-DeepLearningCompilers.pdf) \]  
    ...
    *Mathieu Fehr, Jeff Niu* \[ [Video](https://youtu.be/Lpr_GcX5uKE) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Fehr-Niu-UnlockingHighPerformanceInMojo.pdf) \]  
    ...
    *Jayaram Bobba* \[ [Video](https://youtu.be/IrOibLzfFtE) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Bobba-SpeedingUpIntelGaudi.pdf) \]  
    ...
    *Markus Böck, Sasha Lopoukhine* \[ [Video](https://youtu.be/RSTjn_wA16A) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Bock-Lopoukhine-Quidditch.pdf) \]  
    ...
    *Gonzalo Brito Gadeschi* \[ [Video](https://youtu.be/aUwv2vlOZK4) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Brito-Atomic-reductions.pdf) \]  
    ...
    *Chris Bieneman* \[ [Video](https://youtu.be/dCzd05hCRqs) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Bieneman-LLVM-Project-Governance.pdf) \]  
    ...
    *Chia-Hung Duan, Christopher Ferris* \[ [Video](https://youtu.be/bRomqthp9Ck) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Duan-Ferris-WhyYouShouldUseScudo) \]  
    ...
    *Carlos Seo* \[ [Video](https://youtu.be/AcA_Dh7srRY) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Seo-Building-glibc-withLLVM.pdf) \]  
    ...
    *Mikhail R. Gadelha* \[ [Video](https://youtu.be/GytmaH64wFo) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Gadelha-RISC-V-SupportIntoLLVM-libc.pdf) \]  
    ...
    *Muhammad Omair Javaid* \[ [Video](https://youtu.be/MVgDQNzNDB0) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/quicktalks/Javaid-SPEC-2017.pdf) \]  
    ...
    *Peter Smith* \[ [Video](https://youtu.be/ctgkbaYwT_I) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/lightning/Smith-Using-llvm-libc.pdf) \]  
    ...
    *Ted Woodward* \[ [Video](https://youtu.be/YSdeFLdL5DM) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/lightning/Woodward-RISC-V-Debugger.pdf) \]  
    ...
    *Jonas Devlieghere* \[ [Video](https://youtu.be/JIBhafjL_oo) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/lightning/Devlieghere-MD5-Checksums-In-LLDB.pdf) \]  
    ...
    *Ilya Kuklin* \[ [Video](https://youtu.be/mYze6ndZuZ8) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/lightning/Kuklin-Experiments-with-two-phase-expression-evaluation.pdf) \]  
    ...
    Flang Update  
    *Steve Scalpone* \[ [Video](https://youtu.be/xfBANFcMhCo) \] \[ [Slides](https://llvm.org/devmtg/2024-10/slides/lightning/Scalpone-FlangUpdate.pdf) \]  
    ...
    *Baodi Shan* \[ [Poster](https://llvm.org/devmtg/2024-10/slides/poster/Shan-Fuzzlang-Poster.pdf) \]  
    ...
    *Fabian Mora-Cordero* \[ Poster \]  
    In this talk, we present the XLG framework, a novel intermediate representation capable of replacing ASTs with MLIR. As part of the talk, we will also examine how to perform semantic analysis, code generation, and constant evaluation on XLG. Furthermore, we will demonstrate how these tasks can be performed in an extensible manner, allowing the introduction of new semantics rules or constructs as plugins. Finally, we present how to interoperate XLG with existing dialects and leverage existing MLIR passes to handle often tricky programming notions like meta-programming.

    accfg: Eliminating Setup Overhead for Accelerator Dispatch  
    *Anton Lydike, Josse Van Delm* \[ Poster\]  
    ...
    *Amy Wang* \[ [Poster](https://llvm.org/devmtg/2024-10/slides/poster/Wang-MLIR-and-PyTorch-Poster.pdf) \]  
    ...
    *Farzon Lotfi* \[ Poster \]  
    ...
    New Headergen  
    *Rose Zhang, Aaryan Shukla* \[ Poster \] \[ Slides \]  
    ...
    *Dalia Shaaban* \[ Video \] \[ Slides \]  
    ...
    Autostack: a novel approach to implementing shared stack for image size savings  
    *Sundeep Kushwaha* \[ Poster \]  
