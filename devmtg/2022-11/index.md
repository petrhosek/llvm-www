...
*   **Conference Dates**: November 8-9, 2022  
    (Special events: Nov. 7)
*   **Location**: [Hayes Mansion](https://www.hayesmansion.com) - San Jose, CA
*   **[Registration & Event Website](https://llvm.swoogo.com/2022devmtg/2359289)

    # About

    Visit the official event site for Registration: [https://llvm.swoogo.com/2022devmtg/2359289](https://llvm.swoogo.com/2022devmtg/2359289)

    The LLVM Developers' Meeting is a bi-annual gathering of the entire LLVM Project community. The conference is organized by the [LLVM Foundation](https://foundation.llvm.org) and many volunteers within the LLVM community. Developers and users of LLVM, Clang, and related subprojects will enjoy attending interesting talks, impromptu discussions, and networking with the many members of our community. Whether you are a new to the LLVM project or a long time member, there is something for each attendee.
    ...
    **Keynotes**
    ...
    \[ [Video](https://youtu.be/VbFqA9rvxPs) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Keynote1-PathsTowardsUnifyingLLVMandMLIR.pdf) \]
    ...
    Speaker: Doug Gregor  
    \[ [Video](https://youtu.be/MgPBetJWkmc) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Keynote2-ImplementingLanguageSupportforABI-Swift.pdf) \]
    ...
    **Technical Talks**
    ...
    \[ [Video](https://youtu.be/DmDsgPLFOZA) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk1-Implementing-The-Unimplementable-HLSL.pdf) \]
    ...
    \[ [Video](https://youtu.be/HEhigWu_0uE) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk2-HeterogeneousDebugMetadata.pdf) \]
    ...
    Speaker: Paulo Matos  
    \[ [Video](https://youtu.be/lwPg_Vjs7p4) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk3-ClangClang-WebAssembly.pdf) \]
    ...
    Speaker: Alan Phipps  
    \[ [Video](https://youtu.be/RmX_8GxxTbs) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk4-MCDC-EnablingSafetyCriticalCodeCoverage.pdf) \] \[ [PPT](https://llvm.org/devmtg/2022-11/slides/TechTalk4-MCDC-EnablingSafetyCriticalCodeCoverage.pptx) \]
    ...
    \[ [Video](https://youtu.be/oTwXLEsdhug) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk5-WhatDoesItTakeToRunLLVMBuildbots.pdf) \]
    ...
    \[ [Video](https://youtu.be/58spqN4ksac) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk6-llvm-gitbom.pdf) \] \[ [PPT](https://llvm.org/devmtg/2022-11/slides/TechTalk6-llvm-gitbom.pptx) \]
    ...
    Speaker: Ruobing Han  
    \[ [Video](https://youtu.be/jlo5NM62MnI) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk7-CuPBoP-CUDAForParallelizedBroadRangeProcessors.pdf) \]
    ...
    \[ [Video](https://youtu.be/0S3Njyhd0ks) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk8-UniformityAnalysisForIrreducibleCFGs.pdf) \]
    ...
    \[ [Video](https://youtu.be/E9GdNKjGZ7Y) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk9-UsingContent-AddressableStorage.pdf) \]
    ...
    \[ [Video](https://youtu.be/MT0vQgXbGmg) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk10-DirectGPUCompilationAndExecution.pdf) \]
    ...
    Speaker: Gai Liu  
    \[ [Video](https://youtu.be/YXUKxQQ_qTM) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk11-LinkerCodeSizeOptimization.pdf) \]
    ...
    \[ [Video](https://youtu.be/s1u_E_6_fvY) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk12-Minotaur.pdf) \]
    ...
    \[ [Video](https://youtu.be/GhLoLO0Kuzg) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk13-ML-basedHardwareCostModel-MLIR.pdf) \]
    ...
    \[ [Video](https://youtu.be/YFqWa4pxXzM) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk14-VAST-MLIRForProgramAnalysis.pdf) \]
    ...
    \[ [Video](https://youtu.be/cyMQbZ0B84Q) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk15-ShortLambdatheUltimateSSA.pdf) \]
    ...
    \[ [Video](https://youtu.be/qte1OJdpgkY) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk16-SPIR-V-Backend-in-LLVM.pdf) \]
    ...
    \[ [Video](https://youtu.be/nxFD4DBVxOk) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk17-IRDL-ADialectForDialects.pdf) \]
    ...
    \[ [Video](https://youtu.be/QLnPfcDNcpY) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk18-AutomatedTranslationValidation.pdf) \]
    ...
    Speaker: Nicolai Hähnle  
    \[ [Video](https://youtu.be/4NLw4IFRTY0) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk19-llvm-dialects.pdf) \]
    ...
    \[ [Video](https://youtu.be/Yyj2Fex9yEo) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk20-YARPGen-CompilerFuzzer.pdf) \] \[ [PPT](https://llvm.org/devmtg/2022-11/slides/TechTalk20-YARPGen-CompilerFuzzer.pptx) \]
    ...
    \[ [Video](https://youtu.be/TmWs3QsSuUg) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk21-RISC-VSignExtensionOptimizations.pdf) \]
    ...
    \[ [Video](https://youtu.be/s7nNYZvkGi8) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/TechTalk22-ExecutionDomainTransition.pdf) \]
    ...
    **Tutorials:**
    ...
    \[ [Video](https://youtu.be/OpY4lnpnbq4) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Tutorial1-UsingLLVM-libc.pdf) \]
    ...
    Speaker: Sunho Kim  
    \[ [Video](https://youtu.be/UwHgCqQ2DDA) \] \[[Slides](https://llvm.org/devmtg/2022-11/slides/Tutorial2-JITLink.pdf) \]
    ...
    **Panels:**
    ...
    \[[Video](https://youtu.be/0uUKDQyn1Z4)\] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Panel1-MLGO.pdf) \]
    ...
    \[ [Video](https://youtu.be/aGMJ1vxRAUs) \]
    ...
    *   Changes in upstream llvm-project that will help
    ...
    \[ [Video](https://youtu.be/KssLXUpQboc) \]
    ...
    \[ [Video](https://youtu.be/ElxPbIX4rDU) \]
    ...
    **Quick Talks:**
    ...
    \[ [Video](https://youtu.be/u1WoRj9ioxQ) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuckTalk1-EducationEffort.pdf) \]
    ...
    \[ [Video](https://youtu.be/LDaoJaYStOY) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk2-EnablingAArch64InstrumentationSupportinBOLT.pdf) \]
    ...
    \[ [Video](https://youtu.be/iM2EH5EmoSY) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk5-InteractiveCrashlogsInLLDB.pdf) \]
    ...
    Speaker: Zixu Wang  
    \[ [Video](https://youtu.be/jXrNZ-4Gb-g) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk6-clang-extract-api.pdf) \]
    ...
    Speaker: Tue Ly  
    \[ [Video](https://youtu.be/9bvdbdn0nMA) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk7-UsingModernCPUInstructionsToImproveLLVM-libcMathLibrary.pdf) \]
    ...
    \[ [Video](https://youtu.be/AT-ttb6VwRA) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk8-ChallengesOfEnablingGolangBinariesOptimizationByBOLT.pdf) \]
    ...
    \[ [Video](https://youtu.be/8Uiv2RsPim4) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk9-InliningForSize.pdf) \]
    ...
    \[ [Video](https://youtu.be/AGwEgGqRiOY) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk10-AutomaticIndirectMemoryAccessInstructions.pdf) \] \[ [PPT](https://llvm.org/devmtg/2022-11/slides/QuickTalk10-AutomaticIndirectMemoryAccessInstructions.ppsx) \]
    ...
    Speaker: Todd Snider  
    \[ [Video](https://youtu.be/OkGsMrVd2y8) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk11-Link-TimeAttributesforLTO.pdf) \]
    ...
    \[ [Video](https://youtu.be/g-lvF7rM7fw) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk12-ExpectingTheExpected.pdf) \]

    LLVM's \_\_builtin\_expect, and a variant we recently added, \_\_builtin\_expect\_with\_probability, allow source code control over branch weights and can boost performance with or without PGO via hot/cold splitting. But in LLVM optimization, it's not always intuitive how to update branch weight metadata with control flow changes. We talk about recent issues with losing branch weights in SimplifyCFG and possible improvements to the infrastructure for maintaining branch weights.

    CUDA-OMP — Or, Breaking the Vendor Lock  
    Speaker: Joseph Huber, Johannes Doerfert  
    \[ [Video](https://youtu.be/7m8kn5_l970) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk13-CUDA-OMP-BreakingTheVendorLock.pdf) \]
    ...
    \[ [Video](https://youtu.be/YMI382d4Vz4) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk14-ThoughtsonGPUsAsFirst-ClassCitizens.pdf) \]
    ...
    \[ [Video](https://youtu.be/vjtPWZRxAkI) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/QuickTalk15-BuildingAnEnd-to-EndToolchainForFullyHomomorphicEncryptionWithMLIR.pdf) \]
    ...
    **Lightning Talks:**
    ...
    \[ [Video](https://youtu.be/2aS12AqErik) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning1-LLVMOfficeHours.pdf) \]
    ...
    Speaker: Peter Rong  
    \[ [Video](https://youtu.be/LfpmUxIuKgo) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning2-ImprovingIRFuzzingWithMoreDiversifiedInput.pdf) \]
    ...
    Speaker: David Spickett  
    \[ [Video](https://youtu.be/Gf0FUiY2TRo) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning3-InteractiveProgrammingForLLVMTableGen.pdf) \]
    ...
    \[ [Video](https://youtu.be/dosXtBAFWiE) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning4-EfficientJIT-basedRemoteExecution.pdf) \]
    ...
    Speaker: Yifei He  
    \[ [Video](https://youtu.be/2Q0GETWe76s) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning5-FFTc-AnMLIRDialect.pdf) \]
    ...
    \[ [Video](https://youtu.be/LSPBPC2av54) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning6-RecoveringFromErrorsInClang-ReplAndCodeUndo.pdf) \]
    ...
    \[ [Video](https://youtu.be/8HUnqLjCewU) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning7-10CommitsTowardsGlobalISelForPowerPC.pdf) \]
    ...
    \[ [Video](https://youtu.be/F8PeWkeEw0Y) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning8-SPRAY-Reproducible.pdf) \]
    ...
    \[ [Video](https://youtu.be/bZ2HPrSkTZI) \] \[ [Slides](&lt;https://llvm.org/devmtg/2022-11/slides/Lightning9-TypeResugaringInClang .pdf&gt;) \]

    In this presentation, we talk about the effort to implement type resugaring in Clang. This is an economical way to solve, for the majority of cases, diagnostic issues related to the canonicalization of template arguments during instantiation. The infamous 'std::basic\_string' appearing on the diagnostics when the user wrote 'std::string' is the classic example."

    Swift Bindings for LLVM  
    Speaker: Egor Zhdan  
    \[ [Video](https://youtu.be/G1y-3ikIPm8) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning10-SwiftBindingsForLLVM.pdf) \]
    ...
    \[ [Video](https://youtu.be/NuXk1V19pew) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning11-MinimumSizeFunctionCoverage.pdf) \]
    ...
    \[ [Video](https://youtu.be/Ivyhuj_zCxE) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning12-High-PerformanceGPU-to-CPUTranspilationAndOptimization.pdf) \]

    We extent Polygeist/MLIR to succinctly representation, optimize, and transpile CPU and GPU parallel programs. Through the use of our new operations (e.g. memory effects-based barrier) and transformations, we can successfully transpile GPU Rodinia and PyTorch benchmarks to efficiently run on the CPU \_faster\_ than their existing CPU parallel versions.

    Tools for checking and writing non-trivial DWARF programs  
    Speaker: Chris Jackson  
    \[ [Video](https://youtu.be/ywSMVnJOeiw) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning13-ToolsForCheckingAndWritingNon-trivialDWARFPrograms.pdf) \]
    ...
    \[ [Video](https://youtu.be/gxrD6M-OnLo) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning14-AnalysisOfRISC-V-VectorPerformanceUsingMCATools.pdf) \]
    ...
    Speaker: Amir Ayupov  
    \[ [Video](https://youtu.be/wO878A3eSOA) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning15-OptimizingClangWithBOLTUsingCMake.pdf) \]
    ...
    \[ [Video](https://youtu.be/HrqcS1aX5d8) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/Lightning16-ExploringOpenMPTargetOffloadingForTheGraphCoreArchitecture.pdf) \]
    ...
    **Student Technical Talks:**
    ...
    \[ [Video](https://youtu.be/iGbdcItU0F8) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/StudentTechTalk1-MergingSimilarControl-FlowRegions.pdf) \] \[ [PPT](https://llvm.org/devmtg/2022-11/slides/StudentTechTalk1-MergingSimilarControl-FlowRegions.pptx) \]
    ...
    Speaker: Yuyou Fan  
    \[ [Video](https://youtu.be/TrCfvDHPrrs) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/StudentTechTalk2-Alive-mutate.pdf) \]
    ...
    \[ [Video](https://youtu.be/bTIZLFYpLIM) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/StudentTalk3-EnablingTransformersToUnderstandLow-LevelPrograms.pdf) \]
    ...
    \[ [Video](https://youtu.be/HPv8VUWGAvw) \] \[ [Slides](https://llvm.org/devmtg/2022-11/slides/StudentTalk4-LAGradLeveragingMLIRForEfficientDifferentiableProgramming.pdf) \]
