...
*   **Location**: [Clayton Hotel Burlington Road](https://www.claytonhotels.com/burlington-road/), Dublin, Ireland
*   **[Event Website](https://llvm.swoogo.com/2026eurollvm/)**
...
For future announcements or questions: Please visit the [LLVM Discourse forums](https://discourse.llvm.org). Most posts are in the Announcements or Community categories and tagged with [eurollvm](https://discourse.llvm.org/tag/eurollvm)

# Program

**Keynotes**

*Capabilities Great and Small: CHERI, CHERIoT, and LLVM* \[ [Slides](slides/keynote/keynote_anderson.pdf) \]  
...
*Keynote: The Testing Funnel: Validating LLVM at Scale* \[ [Slides](slides/keynote/keynote_kleckner.pdf) \]  
...
*Fast-math flags: a bag of issues and a handful of solutions* \[ [Slides](slides/technical_talk/technical_talk_pirog.pdf) \]  
...
*MLIR-iteration cycle goes brrr: defining ops and rewrites in Python* \[ [Slides](slides/technical_talk/technical_talk_morel.pdf) \]  
Speaker: Rolf Morel  
...
*Scaling Certified Instruction Selection For LLVM IR Through Bitblasting* \[ [Slides](slides/technical_talk/technical_talk_cicolini_kuhn.pdf) \]  
...
*The LLVM Release Process, a status update* \[ [Slides](slides/technical_talk/technical_talk_hieta_rhoades_yung.pdf) \]  
...
*Toward A More Declarative InstCombine: Generalization & Parametric Bitvector Algorithms* \[ [Slides](slides/technical_talk/technical_talk_bhat.pdf) \]  
...
*Rust or CHERI?* \[ [Slides](slides/technical_talk/technical_talk_marangoni.pdf) \]  
...
*Tracking Warnings at Scale: Extending Clang Diagnostics to Support Issue Baselining and Backslide Prevention* \[ [Slides](slides/technical_talk/technical_talk_bartolomeo.pdf) \]  
...
*Lighthouse: infrastructure for end-to-end MLIR-compilers and testing* \[ [Slides](slides/technical_talk/technical_talk_golin.pdf) \]  
...
*What Compiler Implementers and Language Designers Need to Know About Pointer Authentication* \[ [Slides](slides/technical_talk/technical_talk_hunt.pdf) \]  
Speaker: Oliver Hunt  
...
*Effective Clang Tidy* \[ [Slides](slides/technical_talk/technical_talk_james.pdf) \]  
Speaker: Tom James  
...
*CppInterOp: Interactive C++ as a Service and Advanced Language Interoperability* \[ [Slides](slides/technical_talk/technical_talk_jomy.pdf) \]  
Speaker: Aaron Jomy  
...
*clang-reforge: Automatic whole-codebase source code rewriting tool for security hardening* \[ [Slides](slides/technical_talk/technical_talk_korous.pdf) \]  
Speaker: Jan Korous  
...
*Finding Injection Vulnerabilities: Improvements of the Taint Analysis of the Clang Static Analyzer* \[ [Slides](slides/technical_talk/technical_talk_krupp.pdf) \]  
...
*Bounds Checking with the Clang Static Analyzer: Improvements and Insights* \[ [Slides](slides/technical_talk/technical_talk_nagy.pdf) \]  
Speaker: Donat Nagy  
...
*Floating-Point Types in MLIR: Infrastructure, New Types and Dialect Design* \[ [Slides](slides/technical_talk/technical_talk_springer.pdf) \]  
...
*Optimising small AArch64 cores: stories from the trenches* \[ [Slides](slides/technical_talk/technical_talk_stuij.pdf) \]  
Speaker: Ties Stuij  
...
*Writing a Formal Execution and Memory Model for Execution Synchronization Primitives on AMD GPUs.* \[ [Slides](slides/technical_talk/technical_talk_van_houtryve.pdf) \]  
...
*Adding Nullability Checking and Annotations to Many Millions of Lines of Code* \[ [Slides](slides/technical_talk/technical_talk_voung.pdf) \]  
Speaker: Jan Voung  
...
*rocMLIR: High-Performance ML Compilation for AMD GPUs with MLIR* \[ [Slides](slides/technical_talk/technical_talk_martinez.pdf) \]  
...
*LLVM Foundation Updates* \[ [Slides](slides/llvm_foundation/llvm_foundation_updates.pdf) \]  
...
*All About Alias Analysis* \[ [Slides](slides/tutorial/tutorial_popov.pdf) \]  
...
*Creating a runtime using the LLVM\_ENABLE\_RUNTIMES system* \[ [Slides](slides/tutorial/tutorial_kruse.pdf) \]  
...
*Hands-on Using Clang as a library* \[ [Slides](slides/tutorial/tutorial_jomy.pdf) \]  
Speaker: Aaron Jomy  
...
*Implementing C++26 std::simd with LLVM: A Layered, Compiler-First Approach* \[ [Slides](slides/tutorial/tutorial_towner.pdf) \]  
...
*Challenges in binary rewriting: enabling BOLT to optimize CFI-hardened binaries* \[ [Slides](slides/quick_talk/quick_talk_balint.pdf) \]  
...
*Anatomy of Tiling and Vectorizing linalg.pack and linalg.unpack* \[ [Slides](slides/quick_talk/quick_talk_beysel.pdf) \]  
Speaker: Ege Beysel  
...
*Leveraging BOLT to improve data prefetching for AArch64 binaries* \[ [Slides](slides/quick_talk/quick_talk_chen_wei.pdf) \]  
...
*Mojo Compile-time Interpreter in MLIR* \[ [Slides](slides/quick_talk/quick_talk_chen.pdf) \]  
Speaker: Weiwei Chen  
...
*Self-Contained, Target-Specific GEMM Code Generation in MLIR* \[ [Slides](slides/quick_talk/quick_talk_golin_morel_siemieniuk.pdf) \]  
...
*LLVM JIT — Upcoming Challenges and Opportunities* \[ [Slides](slides/quick_talk/quick_talk_hames.pdf) \]  
Speaker: Lang Hames  
...
*Apple GPU Support in Mojo* \[ [Slides](slides/quick_talk/quick_talk_panchenko.pdf) \]  
...
*Attack of the Clones: Speeding Up Coroutine Compilation* \[ [Slides](slides/quick_talk/quick_talk_pianykh.pdf) \]  
...
*Tracking Operations Through MLIR Pass Pipelines Using Source Locations* \[ [Slides](slides/quick_talk/quick_talk_walbroel.pdf) \]  
...
*Using MLIR Linalg Category Ops for Smarter Compilation* \[ [Slides](slides/lightning_talk/lightning_talk_absar.pdf) \]  
Speaker: Javed Absar  
...
*Highlighting function names in LLDB backtraces* \[ [Slides](slides/lightning_talk/lightning_talk_buch.pdf) \]  
...
*Engineering a Hybrid Rust and MLIR Toolchain for AI Agents* \[ [Slides](slides/lightning_talk/lightning_talk_cardenas.pdf) \]  
...
*Compact Unwind Information for ELF* \[ [Slides](slides/lightning_talk/lightning_talk_engelke.pdf) \]  
...
*Coverage directed codebase reduction for the procedural generation of LIT tests* \[ [Slides](slides/lightning_talk/lightning_talk_fewtrell.pdf) \]  
...
*Improving DemandedBits Analysis for Shift Operations in LLVM* \[ [Slides](slides/lightning_talk/lightning_talk_karouzakis.pdf) \]  
...
*STRTAB Hash & Slash: Reducing STRTAB size by hashing its entries* \[ [Slides](slides/lightning_talk/lightning_talk_nguyen.pdf) \]  
Speaker: Vy Nguyen  
...
*Extending Lifetime Safety: Verification of \[\[clang:noescape\]\] annotation* \[ [Slides](slides/lightning_talk/lightning_talk_pradeep.pdf) \]  
...
*Reproducible Large-Workload Recipes for BOLT with Nixpkgs* \[ [Slides](slides/lightning_talk/lightning_talk_waller.pdf) \]  
...
*What’s new in LLDB on Windows* \[ [Slides](slides/lightning_talk/lightning_talk_zablit.pdf) \]  
...
*IR2Vec Python Bindings: Native Integration for Pythonic, ML Workflows* \[ [Slides](slides/student_technical_talk/student_technical_talk_sachdeva.pdf) \]  
...
*GPU optimizations, and where Rust knows more than LLVM* \[ [Slides](slides/student_technical_talk/student_technical_talk_dominguez.pdf) \]  
...
*Accelerating Pass Order Auto-tuning via Profile-Guided Cost Modeling* \[ [Slides](slides/student_technical_talk/student_technical_talk_gao.pdf) \]  
...
*Clang and LLVM in Modern Gaming Platforms* \[ [Slides](slides/panel/panel_bieneman_haehnle_hieta_klinge_morse.pdf) \]  
...
*MemorySSA-Based Reaching Definitions for IR2Vec Flow-Aware Embeddings* \[ [Slides](slides/poster/poster_sachdeva.pdf) \]  
Speaker: Nishant Sachdeva  
...
*Bridging Runtime Gaps in LLVM: Vendor-Agnostic Dispatch for ML Kernels* \[ [Slides](slides/poster/poster_akash.pdf) \]  
Speaker: S Akash  
...
*Engineering a Hybrid Rust and MLIR Toolchain for AI Agents* \[ [Slides](slides/poster/poster_cardenas.pdf) \]  
Speaker: Miguel Cárdenas  

Developing a compiler for Agentic AI workloads presents a unique challenge because the runtime demands the safety and ergonomics of Rust while the optimization pipeline requires the mature infrastructure of MLIR. This talk presents the architecture of a toolchain designed to leverage the strengths of both ecosystems. We discuss how we structured a hybrid build system where Rust drives the compilation process and defines runtime semantics, while C++ manages the core MLIR dialect and transformations. The session covers the practical engineering required to bridge these worlds, from orchestrating CMake and Cargo to managing the boundary between Rust runtime metadata and MLIR operation definitions. We share lessons learned about the complexity of linking, the tradeoffs of code generation, and the reality of maintaining a custom dialect across the language barrier.

*Floating-Point Datapaths in CIRCT via FloPoCo AST Export and flopoco-arith-to-comb lowering* \[ [Slides](slides/poster/poster_cochard_de_dinechin_ledoux.pdf) \]  
...
*Adding Compilation Metadata To Binaries To Make Disassembly Decidable* \[ [Slides](slides/poster/poster_engel.pdf) \]  
...
*A CPU Autotuning Pipeline for MLIR-IREE* \[ [Slides](slides/poster/poster_huang_lee.pdf) \]  
...
*A stride towards generating segment accesses in RVV* \[ [Slides](slides/poster/poster_kastoras.pdf) \]  
...
*Non-destructive PDL Rewriting for Multi-Level Equality Saturation* \[ [Slides](slides/poster/poster_lopoukhine_merckx.pdf) \]  
...
*Confirming the Impact of Warning Message Quality in the Clang Static Analyzer* \[ [Slides](slides/poster/poster_umann.pdf) \]  
...
*CUDA Tile IR: Lessons from a Tile-Centric CUDA Dialect for MLIR* \[ [Slides](slides/mlir/mlir_springer.pdf) \]  
...
*Auto-tuning MLIR schedules: a case study targeting Intel GPUs* \[ [Slides](slides/mlir/mlir_karna.pdf) \]  
...
*Progressive Arithmetic Lowering from Tensor Kernels to Synthesizable Datapaths* \[ [Slides](slides/mlir/mlir_ledoux.pdf) \]  
...
*From Graphs to Warps: Semantic Interoperability Across MLIR Abstraction Levels* \[ [Slides](slides/mlir/mlir_gargi.pdf) \]  
...
*Beyond Constants: Mojo’s Attribute-Based Expression System* \[ [Slides](slides/mlir/mlir_zhu.pdf) \]  
Speaker: Billy Zhu  
...
*Tamagoyaki: MLIR-Native Equality Saturation* \[ [Slides](slides/mlir/mlir_merckx.pdf) \]  
...
*MLIR-RAJA: Bridging AI Models and HPC Performance Portability* \[ [Slides](slides/mlir/mlir_pang.pdf) \]  
