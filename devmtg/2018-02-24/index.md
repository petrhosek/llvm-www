...
An LLVM Performance Workshop will be held at CGO 2018. The workshop is co-located with CC, HPCA, and PPoPP. It takes place at the [Austria Trend Eventhotel Pyramide](http://cgo.org/cgo2018/venue/) in Vienna. If you are interested in attending the workshop, please register at the [CGO website.](http://cgo.org/cgo2018/workshops.html)

# Schedule

| **Time** | **Room** | **Speaker** | **Title** |   |
| --- | --- | --- | --- | --- |
| 9:15 | Europa 2 | Maha Kooli | How to Evaluate "In-Memory Computing" Performances without Hardware Measurements? | [\[Abstract\]](#mk) |
| 10:00-10:30 |   | Coffee Break |
| 10:30 | Europa 2 | Arsène Pérard-Gayot | Optimizing LLVM IR for Guided Vectorization | [\[Abstract\]](#apg) |
| 11:15 | Europa 2 | Siddharth Shankar Swain | Efficient use of memory by reducing size of AST dumps in cross file analysis by clang static analyzer | [\[Abstract\]](#sss) |
| 12:00-13:30 |   | Lunch |
| 13:30 | Europa 2 | Julian Hammer | Cache-aware Scheduling and Performance Modeling with LLVM-Polly and Kerncraft | [\[Abstract\]](#jh) [\[Slides\]](./slides/hammer_2018_CGO_LLVM_perf.pdf) |
| 14:15 | Europa 2 | Alexander Matz | Enabling Automatic Partitioning of Data-Parallel Kernels with Polyhedral Compilation | [\[Abstract\]](#am) [\[Slides\]](./slides/matz_2018_CGO_LLVM_perf.pdf) |
| 15:00-15:30 |   | Coffee Break |
| 15:30 | Europa 2 | William Moses | Tensor Comprehensions | [\[Abstract\]](#wm) |
| 16:15 | Europa 2 |   | LLVM Q&A Panel: **Questions Welcome** |   |
| 17:00 |   | Workshop ends. |

# Abstracts

*   **Julian Hammer, Johannes Doerfert, Georg Hager, Gerhard Wellein and Sebastian Hack**: Cache-aware Scheduling and Performance Modeling with LLVM-Polly and Kerncraft Compilation  [\[Slides\]](./slides/hammer_2018_CGO_LLVM_perf.pdf)
...
*   **Alexander Matz and Holger Fröning**: Enabling Automatic Partitioning of Data-Parallel Kernels with Polyhedral Compilation  [\[Slides\]](./slides/matz_2018_CGO_LLVM_perf.pdf)
