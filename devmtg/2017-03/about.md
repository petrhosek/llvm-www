...
<html>
  ...
  <body>
    ...
    <section id="banner">
      <header>
        <h2>
          <em>EuroLLVM'17 will take place on the</em>
          <a href="http://www.cs.uni-saarland.de" target="_blank"
            >Saarland Informatics Campus</a
          >
          <em>at</em>
          <a href="http://www.uni-saarland.de" target="_blank"
            >Saarland University</a
          ><em> in Saarbrücken, Germany</em>
        </h2>
      </header>
    </section>
        ...
        <div class="row">
          <section class="6u">
            <div class="box post">
              <a href="#" class="image left"
                ><img
                  src="http://llvm.org/devmtg/2017-03//assets/images/pic01.jpg"
                  alt=""
              /></a>
              <div class="inner">
          ...
          <section class="6u">
            <div class="box post">
              <a href="#" class="image left"
                ><img
                  src="http://llvm.org/devmtg/2017-03//assets/images/pic02.jpg"
                  alt=""
              /></a>
              <div class="inner">
        ...
        <div class="row">
          <section class="6u">
            <div class="box post">
              <a href="#" class="image left"
                ><img
                  src="http://llvm.org/devmtg/2017-03//assets/images/pic03.jpg"
                  alt=""
              /></a>
              <div class="inner">
          ...
          <section class="6u">
            <div class="box post">
              <a href="#" class="image left"
                ><img
                  src="http://llvm.org/devmtg/2017-03//assets/images/pic04.jpg"
                  alt=""
              /></a>
              <div class="inner">
