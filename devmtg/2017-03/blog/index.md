---
permalink: "devmtg/2017-03/blog/index.html"
---
<!doctype html>
<!--
	Arcana by HTML5 UP
    ...
    <div id="header">
      ...
      <nav id="nav">
        <ul>
          ...
          <li class="current">
            <a href="http://llvm.org/devmtg/2017-03/blog">News</a>
          </li>
          <li>
          ...
          <!--li class="current"><a href="http://llvm.org/devmtg/2017-03/venue.html">Venue &amp; Accommodation</a></li>-->
                    ...
                    <div class="box post">
                      ...
                      <div class="inner">
                        ...
                        <p>
                          ...
                          sessions is now available and can be browsed below.
                          The schedule can be found
                          <a href="https://eurollvm2017.sched.com/">here</a>.
                        </p>
                ...
                <div class="row">
                  <section class="12u">
                    <div class="box post">
                      <a href="#" class="image left"
                        ><img
                          src="http://llvm.org/devmtg/2017-03//assets/images/gradschoolCSText.jpg"
                          alt=""
                      /></a>
                      <div class="inner">
                        <h3>Student Travel Grants Available</h3>
                        <p>
                          Details for the Student Travel Grants are available!
                        </p>

                        <footer>
                          <a
                            href="http://llvm.org/devmtg/2017-03//2017/01/21/student-travel-grants.html"
                            class="button"
                            >Continue Reading</a
                          >
                        </footer>
                ...
                <div class="row">
                  <section class="12u">
                    <div class="box post">
                      <a href="#" class="image left"
                        ><img
                          src="http://llvm.org/devmtg/2017-03//assets/images/CSUniSBText.jpg"
                          alt=""
                      /></a>
                      <div class="inner">
                        <h3>The Registration is Open</h3>
                        <p>
                          The registration for the 2017 European Developers
                          Meeting has been closed due to high demand.
                        </p>

                        <footer>
                          <a
                            href="http://llvm.org/devmtg/2017-03//2017/01/11/registration-open.html"
                            class="button"
                            >Continue Reading</a
                          >
                        </footer>
                  ...
                  <section class="12u">
                    <div class="box post">
                      ...
                      <div class="inner">
                        ...
                        <p>
                          Today we are happy to announce that Saarbrücken has
                          been selected for hosting the 2017 European LLVM
                          Developers Meeting. Saarbrücken is the capital of
                          Germany's federal state Saarland. It is situated in
                          the southwest of Germany in very close proximity to
                          the French and Luxembourgian borders.
                        </p>

                        <footer>
                          <a
                            href="http://llvm.org/devmtg/2017-03//2016/10/14/venue-selected.html"
                            class="button"
                            >Continue Reading</a
                          >
                        </footer>
