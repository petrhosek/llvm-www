...
*   Lessons Learned Implementing Common Lisp with LLVM over Six Years \[ [Video](https://youtu.be/mbdXeRBbgDM) \] \[ Slides \]  
...
*   Porting Function merging pass to thinlto \[ [Video](https://youtu.be/GxQmcvYpKYU) \] \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Kumar-FunctionMergingPortThinLTO.pdf) \]  
    *Aditya Kumar*
...
*   Profile Guided Function Layout in LLVM and LLD \[ [Video](https://youtu.be/F-lbgspxv1c) \] \[ [Slides](&lt;slides/Spencer-Profile Guided Function Layout in LLVM and LLD.pdf&gt;) \]  
    *Michael Spencer*
...
*   Methods for Maintaining OpenMP Semantics without Being Overly Conservative \[ [Video](https://youtu.be/9BxDNv4YmVw) \] \[ [Slides](slides/Jin-OpenMPSemantics.pdf) \]  
...
*   Art Class for Dragons: Supporting GPU compilation without metadata hacks!  
    *Neil Hickey*
    ...
    \[1\] - https://www.khronos.org/registry/vulkan/ \[2\] - https://github.com/KhronosGroup/SPIRV-LLVM-Translator \[3\] - https://github.com/Microsoft/DirectXShaderCompiler/blob/master/docs/DXIL.rst \[4\] - https://github.com/GPUOpen-Drivers/AMDVLK \[5\] - https://www.khronos.org/registry/SPIR/specs/spir\_spec-2.0.pdf \[6\] - https://docs.nvidia.com/cuda/pdf/NVVM\_IR\_Specification.pdf

*   Implementing an OpenCL compiler for CPU in LLVM \[ [Video](https://youtu.be/Mm5ATyqm7Rw) \] \[ [Slides](slides/Tyurin-ImplementingOpenCLCompiler.pdf) \]  
    *Evgeniy Tyurin*
...
*   Loop Transformations in LLVM: The Good, the Bad, and the Ugly \[ [Video](https://youtu.be/QpvZt9w-Jik) \] \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Kruse-LoopTransforms.pdf) \]  
...
*   Graph Program Extraction and Device Partitioning in Swift for TensorFlow \[ [Video](https://youtu.be/HSneJdPkaKk) \] \[ [Slides](slides/Hong-Lattner-SwiftForTensorFlowGraphProgramExtraction.pdf) \]  
...
*   Improving code reuse in clang tools with clangmetatool \[ [Video](https://youtu.be/SjjURI5xP-g) \] \[ [Slides](slides/Ruoso-clangmetatool.pdf) \]  
    *Daniel Ruoso*
...
*   Sound Devirtualization in LLVM  
    *Piotr Padlewski, Krzysztof Pszeniczny*  
    \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Padlewski-Pszeniczny-Sound%20Devirtualization.pdf) \]
...
*   Revisiting Loop Fusion, and its place in the loop transformation framework. \[ [Video](https://youtu.be/UVZPtBGV8kQ) \] \[ [Slides (PDF)](https://llvm.org/devmtg/2018-10/slides/Barton-LoopFusion.pdf), [Slides (PPT)](https://llvm.org/devmtg/2018-10/slides/Barton-LoopFusion.pptx) \]  
...
*   Optimizing Indirections, using abstractions without remorse. \[[Video](https://youtu.be/zfiHaPaoQPc)\] \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Doerfert-Johannes-Optimizing-Indirections-Slides-LLVM-2018.pdf) \]  
...
*   How to use LLVM to optimize your parallel programs \[ [Video](https://youtu.be/tmBThobaDBw) \] \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Moses-OptimizeYourParallelPrograms.pdf) \]  
    *William S. Moses*
...
*   Debug Info BoF \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Prantl-Kumar-debug-info-bof-2018.pdf) \]  
...
*   More efficient LLVM devs: 1000x faster build file generation, -j1000 builds, and O(1) test execution \[ [Video](https://youtu.be/gZwu8aBmqtc) \] \[ [Slides](https://llvm.org/devmtg/2018-10/slides/Weber-FunnerLLVMDevelopment.pdf) \]  
    *Nico Weber*
...
*   Mutating the clang AST from Plugins  
    *Andrei Homescu, Per Larsen*
    ...
    The clang AST is generally considered immutable, and clang plugins in particular are expected to consume the AST without modifying it. In the C2Rust project, we are building tools to transpile C code to Rust and cross-check the result using compiler plugins for clang and rustc. The clang cross-checking plugin inserts instrumentation code into C code at compile-time by modifying the clang AST in place. In this talk, we show how the C2Rust clang plugin breaks the "immutable AST" rule by mutating the AST in two significant ways: \* Adding new statements to existing C functions, and \* Creating new C functions that are passed back to clang for compilation. Additionally, the plugin adds a C language extension in the form of a new "cross\_check" attribute for functions, structures and structure fields. This new attribute helps users configure and customize the inserted instrumentation code. We discuss how the plugin implements this attribute, and the alternative implementation approaches we considered.
...
*   Eliminating always\_inline in libc++: a journey of visibility and linkage  
    *Louis Dionne*

    Libc++ has long abused the always\_inline attribute to avoid leaking unstable ABIs through object and library boundaries. This will explain why we stopped using this attribute, what we do instead, and why it matters.
...
*   Gaining fine-grain control over pass management  
    *serge guelton, adrien guinet, pierrick brunet, juan manuel martinez, béatrice creusillet*
    ...
    \[0\] https://www.inf.u-szeged.hu/~akiss/pub/pdf/laszlo\_obfuscating.pdf
