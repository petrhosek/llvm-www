...
*   **Location**: [San Jose Convention Center](http://www.sanjose.org/convention-center/), San Jose, CA, USA
...
*   Active developers of projects in the LLVM Umbrella (LLVM core, Clang, LLDB, libc++, compiler\_rt, klee, lld, etc).
...
Keynotes:  
**[Falcon: An optimizing Java JIT](#talk12)** \- *Philip Reames* \[[Video](https://www.youtube.com/watch?v=Uqch1rjPls8&feature=youtu.be)\] \[[Slides](http://llvm.org/devmtg/2017-10/slides/Reames-FalconKeynote.pdf)\]  
**[Compiling Android userspace and Linux kernel with LLVM](#talk21)** \- *Stephen Hines, Nick Desaulniers and Greg Hackmann* \[[Video](https://youtu.be/6l4DtR5exwo)\] \[[Slides](slides/Hines-CompilingAndroidKeynote.pdf)\]  

Talks:  
**[Apple LLVM GPU Compiler: Embedded Dragons](#talk1)** \- *Marcello Maggioni and Charu Chandrasekaran* \[ [Video](https://youtu.be/VFHYaH5Vr4I) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Chandrasekaran-Maggioni-Apple%20LLVM%20GPU%20Compiler.pdf) \]  
**[Bringing link-time optimization to the embedded world: (Thin)LTO with Linker Scripts](#talk2)** \- *Tobias Edler von Koch, Sergei Larin, Shankar Easwaran and Hemant Kulkarni* \[ [Video](https://youtu.be/hhaPAKUt35E) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/LTOLinkerScriptsEdlerVonKoch.pdf) \]  
**[Advancing Clangd: Bringing persisted indexing to Clang tooling](#talk3)** \- *Marc-Andre Laperle* \[ [Video](https://youtu.be/Y9JB3hlAWeA) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Laperle-Advancing%20Clangd.pdf) \]  
**[The Further Benefits of Explicit Modularization: Modular Codegen](#talk4)** \- *David Blaikie* \[ [Video](https://youtu.be/lYYxDXgbUZ0) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Blaikie-Modular%20Codegen.pdf) \]  
**[eval() in C++](#talk5)** \- *Sean Callanan* \[ [Video](https://youtu.be/BC4iMCa_ADk) \] \[ Slides \]  
**[The Type Sanitizer: Free Yourself from -fno-strict-aliasing](#talk6)** \- *Hal Finkel* \[ [Video](https://youtu.be/vAXJeN7k32Y) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Finkel-The%20Type%20Sanitizer.pdf) \]  

**[Enabling Parallel Computing in Chapel with Clang and LLVM](#talk7)** \- *Michael Ferguson* \[ [Video](https://youtu.be/hJrYAXn2xFE) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Ferguson-Enabling%20Parallel%20Computing%20in%20Chapel.pdf) \]  
**[Structure-aware fuzzing for Clang and LLVM with libprotobuf-mutator](#talk8)** \- *Kostya Serebryany, Vitaly Buka and Matt Morehouse* \[ [Video](https://youtu.be/U60hC16HEDY) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Serebryany-Structure-aware%20fuzzing%20for%20Clang%20and%20LLVM%20with%20libprotobuf-mutator.pdf) \]  
**[Adding Index‐While‐Building and Refactoring to Clang](#talk9)** \- *Alex Lorenz and Nathan Hawes* \[ [Video](https://youtu.be/jGJhnIT-D2M) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Lorenz-Hawes-Index%20while%20building%20and%20refactoring%20in%20Clang.pdf) \]  
**[XRay in LLVM: Function Call Tracing and Analysis](#talk10)** \- *Dean Michael Berris* \[ [Video](https://youtu.be/jyL-__zOGcU) \] \[ [Slides](slides/Berris_XRay_in_LLVM.pdf) \]  
**[GlobalISel: Past, Present, and Future](#talk11)** \- *Quentin Colombet and Ahmed Bougacha* \[ [Video](https://youtu.be/Zh4R40ZyJ2kY) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Bougacha-Colombet-GlobalISel.pdf) \]  
**[Dominator Trees and incremental updates that transcend time](#talk13)** \- *Jakub Kuderski* \[ [Video](https://youtu.be/bNV18Wy-J0U) \] \[ [Slides](slides/Kuderski-Dominator_Trees.pdf) \]  
**[Scale, Robust and Regression-Free Loop Optimizations for Scientific Fortran and Modern C++](#talk14)** \- *Tobias Grosser and Michael Kruse* \[ [Video](https://youtu.be/A8E5KgzZPMM) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Kruse-Regression%20Free%20Loop%20Optimizations.pdf) \]  
**[Implementing Swift Generics](#talk15)** \- *Douglas Gregor, Slava Pestov and John McCall* \[ Video \] \[ [Slides](slides/Pestov-McCall-ImplementingGenerics.pdf) \]  
**[lld: A Fast, Simple, and Portable Linker](#talk16)** \- *Rui Ueyama* \[ [Video](https://youtu.be/yTtWohFzS6s) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Ueyama-lld.pdf) \]  
**[Vectorizing Loops with VPlan – Current State and Next Steps](#talk17)** \- *Ayal Zaks and Gil Rapaport* \[ [Video](https://youtu.be/BjBSJFzYDVk) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Zaks-Vectorizing%20Loops%20with%20VPlan.pdf) \]  
**[LLVM Compile-Time: Challenges. Improvements. Outlook.](#talk18)**  
\- *Michael Zolotukhin* \[ [Video](https://youtu.be/bYHMwyyZ6Mk) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Zolotukhin-LLVM%20Compile%20Time.pdf) \]  
**[Challenges when building an LLVM bitcode Obfuscator](#talk19)** \- *Serge Guelton, Adrien Guinet, Juan Manuel Martinez and Pierrick Brunet* \[ [Video \] \[ < a href="slides/Guelton-Challenges\_when\_building\_an\_LLVM\_bitcode\_Obfuscator.pdf">Slides](https://youtu.be/d72Snpxx4Co) \]  
**[Building Your Product Around LLVM Releases](#talk20)** \- *Tom Stellard* \[ [Video](https://youtu.be/YonXJYfb5xY) \] \[ Slides \]  

BoFs:  
**[Storing Clang data for IDEs and static analysis](#bof1)** \- *Marc-Andre Laperle* \[ [Slides](slides/Laperle-Storing_Clang_Data_BOF.pdf) \]  
**[Source-based Code Coverage BoF](#bof2)** \- *Eli Friedman and Vedant Kumar*  
**[Clang Static Analyzer BoF](#bof3)** \- *Devin Coughlin, Artem Dergachev and Anna Zaks*  
**[Co-ordinating RISC-V development in LLVM](#bof4)** \- *Alex Bradbury*  
**[Thoughts and State for Representing Parallelism with Minimal IR Extensions in LLVM](#bof5)** \- *Xinmin Tian, Hal Finkel, Tb Schardl, Johannes Doerfert and Vikram Adve*  
**[BoF - Loop and Accelerator Compilation Using Integer Polyhedra](#bof6)** \- *Tobias Grosser and Hal Finkel*  
**[LLDB Future Directions](#bof7)** \- *Zachary Turner and David Blaikie*  
**[LLVM Foundation - Status and Involvement](#bof8)** \- *LLVM Foundation Board of Directors*  

Tutorials:  
**[Writing Great Machine Schedulers](#tutorial1)** \- *Javed Absar and Florian Hahn*  
**[Tutorial: Head First into GlobalISel](#tutorial2)** \- *Daniel Sanders, Aditya Nandakumar and Justin Bogner*  
\[ [Video](https://youtu.be/Zh4R40ZyJ2k) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Bogner-Nandakumar-Sanders-Head%20First%20into%20GlobalISel.pdf) \]  
**[Welcome to the back-end: The LLVM machine representation.](#tutorial3)** \- *Matthias Braun* \[ [Video](https://youtu.be/objxlZg01D0) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Braun-Welcome%20to%20the%20Back%20End.pdf) \]  

Lightning Talks:  
**[Porting OpenVMS using LLVM](#lightning1)** \- *John Reagan* \[ [Video](https://youtu.be/xTaBkCBYskA) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Reagan-Porting%20OpenVMS%20Using%20LLVM.pdf) \]  
**[Porting LeakSanitizer: A Beginner's Guide](#lightning2)** \- *Francis Ricci* \[ [Video](https://youtu.be/JH5_c2qMVY8) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Ricci-LeakSanitizer.pdf) \]  
**[Introsort based sorting function for libc++](#lightning3)** \- *Divya Shanmughan and Aditya Kumar* \[ [Video](https://youtu.be/Lcz0ZHewkHs) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Kumar-libc++-performance.pdf) \]  
**[Code Size Optimization: Interprocedural Outlining at the IR Level](#lightning4)** \- *River Riddle* \[ [Video](https://youtu.be/SS1rJzggBu0) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Riddle-Interprocedural%20IR%20Outlining%20For%20Code%20Size.pdf) \]  
**[ThreadSanitizer APIs for external libraries](#lightning5)** \- *Kuba Mracek* \[ [Video](https://youtu.be/-J9bMpqfc7A) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Mracek-TSan%20APIs%20for%20External%20Libraries.pdf) \]  
**[A better shell command-line autocompletion for clang](#lightning6)** \- *Yuka Takahashi* \[ [Video](https://youtu.be/zLPwPdZBpSY) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Takahasi-Bash%20autocompletion.pdf) \]  
**[A CMake toolkit for migrating C++ projects to clang’s module system.](#lightning7)** \- *Raphael Isemann* \[ [Video](https://youtu.be/7UxBYK2AuJQ) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Isemann-A%20CMake%20toolkit.pdf) \]  
**[Debugging of optimized code: Extending the lifetime of local variables](#lightning8)** \- *Wolfgang Pieb* \[ [Video](https://youtu.be/jf4WR_r2Wok) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Pieb-Debugging%20of%20optimized%20code.pdf) \]  
**[An LLVM based Loop Profiler](#lightning10)** \- *Shalini Jain, Kamlesh Kumar, Suresh Purini, Dibyendu Das and Ramakrishna Upadrasta* \[ [Video](https://youtu.be/MKhXpRNekaM) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Kumar-libc++-performance.pdf) \]  
**[Compiling cross-toolchains with CMake and runtimes build](#lightning11)** \- *Petr Hosek* \[ [Video](https://youtu.be/OCQGpUzXDsY) \] \[ [Slides](http://llvm.org/devmtg/2017-10/slides/Hosek-Compiling%20cross-toolchains%20with%20CMake%20and%20runtimes%20build.pdf) \]  

Student Research Competition:  
**[VPlan + RV: A Proposal](#src1)** \- *Simon Moll and Sebastian Hack* \[ [Video](https://youtu.be/svMEphbFukw) \] \[ [Slides](slides/Moll-Vplan.pdf) \]  
**[Polyhedral Value & Memory Analysis](#src2)** \- *Johannes Doerfert and Sebastian Hack* \[ [Video](https://youtu.be/xSA0XLYJ-G0) \] \[ Slides \]  
**[DLVM: A Compiler Framework for Deep Learning DSLs](#src3)** \- *Richard Wei, Vikram Adve and Lane Schwartz* \[ [Video](https://youtu.be/9fdFbVBUQGs) \] \[ [Slides](slides/Wei-DLVM.pdf) \]  
**[Exploiting and improving LLVM's data flow analysis using superoptimizer](#src5)** \- *Jubi Taneja, John Regehr* \[ [Video](://youtu.be/WyMTa2_yNHQ) \] \[ Slides \]  

Posters:  
**[Venerable Variadic Vulnerabilities Vanquished](#poster1)** \- *Priyam Biswas, Alessandro Di Federico, Scott A. Carr, Prabhu Rajasekaran, Stijn Volckaert, Yeoul Na, Michael Franz and Mathias Payer*  
**[Extending LLVM’s masked.gather/scatter Intrinsic to Read/write Contiguous Chunks from/to Arbitrary Locations.](#poster2)** \- *Farhana Aleen, Elena Demikhovsky and Hideki Saito*  
**[An LLVM based Loop Profiler](#poster3)** \- *Shalini Jain, Kamlesh Kumar, Suresh Purini, Dibyendu Das and **Ramakrishna Upadrasta*  
**[Leveraging Compiler Optimizations to Reduce Runtime Fault Recovery Overhead](#poster4)** \- *Fateme S. Hosseini, Pouya Fotouhi, Chengmo Yang and Guang R. Gao*  
**[Polyhedral Optimizations and transparent GPU offloading for Julia by Polly](#poster5)** \- *Sanjay Srivallabh Singapuram*  
**[Improving debug information in LLVM to recover optimized-out function parameters](#poster6)** \- *Ananth Sowda and Ivan Baev*  
**[Adding Debug Information and Merge Attribute to Merge-Functions LLVM passes](#poster7)** \- *Anmol Paralkar*  
**[ALLVM: LLVM All the Things!](#poster8)** \- *Will Dietz and Vikram Adve*  
**[Project Sulong - Executing LLVM IR on top of a JVM](#poster9)** \- *Matthias Grimmer and Christian Wimmer*  
**[JIT Fuzzing Solver: A LibFuzzer based constraint solver](#poster10)** \- *Daniel Liew, Cristian Cadar and Alastair Donaldson*  
**[Non-determinism in LLVM Code Generation](#poster11)** \- *Mandeep Singh Grang*  
**
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Chandrasekaran-Maggioni-Apple%20LLVM%20GPU%20Compiler.pdf)\] \[[Video](https://youtu.be/VFHYaH5Vr4I)\]  
...
\[[Slides](slides/LTOLinkerScriptsEdlerVonKoch.pdf)\] \[[Video](https://youtu.be/hhaPAKUt35E)\]  
...
*Marc-Andre Laperle*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Laperle-Advancing%20Clangd.pdf)\] \[[Video](https://youtu.be/Y9JB3hlAWeA)\]  
...
*David Blaikie*  
\[[Slides\] \[](http://llvm.org/devmtg/2017-10/slides/Blaikie-Modular%20Codegen.pdf)[Video](https://youtu.be/lYYxDXgbUZ0)\]  
...
**eval() in C++**  
*Sean Callanan*  
\[Slides\] \[[Video](https://youtu.be/BC4iMCa_ADk)\]  
...
*Hal Finkel*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Finkel-The%20Type%20Sanitizer.pdf)\] \[[Video](https://youtu.be/vAXJeN7k32Y)\]  
...
*Michael Ferguson*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Ferguson-Enabling%20Parallel%20Computing%20in%20Chapel.pdf)\] \[ [Slides (PPT)](http://llvm.org/devmtg/2017-10/slides/Ferguson-Enabling%20Parallel%20Computing%20in%20Chapel.key)\] \[[Video](https://youtu.be/hJrYAXn2xFE)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Serebryany-Structure-aware%20fuzzing%20for%20Clang%20and%20LLVM%20with%20libprotobuf-mutator.pdf)\] \[[Video](https://youtu.be/U60hC16HEDY)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Lorenz-Hawes-Index%20while%20building%20and%20refactoring%20in%20Clang.pdf)\] \[ [Slides (Keynote)](http://llvm.org/devmtg/2017-10/slides/Lorenz-Hawes-Index%20while%20building%20and%20refactoring%20in%20Clang.key) \] \[[Video](https://youtu.be/jGJhnIT-D2M)\]  
...
*Dean Michael Berris*  
\[Slides\] \[[Video](https://youtu.be/jyL-__zOGcU)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Bougacha-Colombet-GlobalISel.pdf)\] \[[Video](https://youtu.be/McByO0QgqCY)\]  
...
*Philip Reames*  
\[[Slides (PDF)](slides/Reames-FalconKeynote.pdf)\] \[[Slides (PPT)](slides/Reames-FalconKeynote.pptx)\]\[[Video](https://youtu.be/Uqch1rjPls8)\]  
...
*Jakub Kuderski*  
\[Slides\] \[[Video](https://youtu.be/bNV18Wy-J0U)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Kruse-Regression%20Free%20Loop%20Optimizations.pdf)\] \[[Video](https://youtu.be/A8E5KgzZPMM)\]  
...
\[Slides\] \[[Video](https://youtu.be/ctS8FzqcRug)\]  
...
*Rui Ueyama*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Ueyama-lld.pdf)\] \[[Video](https://youtu.be/yTtWohFzS6s)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Zaks-Vectorizing%20Loops%20with%20VPlan.pdf)\] \[ [Slides (PPT)](http://llvm.org/devmtg/2017-10/slides/Zaks-Vectorizing%20Loops%20with%20VPlan.pptx) \] \[[Video](https://youtu.be/BjBSJFzYDVk)\]  
...
*Michael Zolotukhin*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Zolotukhin-LLVM%20Compile%20Time.pdf)\] \[[Video](https://youtu.be/bYHMwyyZ6Mk)\]  
...
\[Slides\] \[[Video](https://youtu.be/d72Snpxx4Co)\]  
...
*Tom Stellard*  
\[Slides\] \[[Video](https://youtu.be/YonXJYfb5xY)\]  
...
\[[Slides](slides/Hines-CompilingAndroidKeynote.pdf)\] \[[Video](https://youtu.be/6l4DtR5exwo)\]  
...
*Marc-Andre Laperle*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Laperle-Storing%20Clang%20Data.pdf)\]  
...
\[Slides\] \[[Video](https://youtu.be/brpomKUynEA)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Bogner-Nandakumar-Sanders-Head%20First%20into%20GlobalISel.pdf)\] \[ [Slides (Keynote)](http://llvm.org/devmtg/2017-10/slides/Bougacha-Colombet-GlobalISel.key) \] \[[Video](https://youtu.be/Zh4R40ZyJ2k)\]  
...
*Matthias Braun*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Braun-Welcome%20to%20the%20Back%20End.pdf)\] \[[Video](https://youtu.be/objxlZg01D0)\]  
...
*John Reagan*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Reagan-Porting%20OpenVMS%20Using%20LLVM.pdf)\] \[[Video](https://youtu.be/xTaBkCBYskA)\]  
...
*Francis Ricci*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Ricci-LeakSanitizer.pdf)\] \[[Video](https://youtu.be/JH5_c2qMVY8)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Kumar-libc++-performance.pdf)\] \[[Video](https://youtu.be/Lcz0ZHewkHs)\]  
...
*River Riddle*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Riddle-Interprocedural%20IR%20Outlining%20For%20Code%20Size.pdf)\] \[[Video](https://youtu.be/SS1rJzggBu0)\]  
...
*Kuba Mracek*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Mracek-TSan%20APIs%20for%20External%20Libraries.pdf)\] \[[Video](https://youtu.be/-J9bMpqfc7A)\]  
...
*Yuka Takahashi*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Takahasi-Bash%20autocompletion.pdf)\] \[[Video](https://youtu.be/zLPwPdZBpSY)\]  
...
*Raphael Isemann*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Isemann-A%20CMake%20toolkit.pdf)\] \[[Video](https://youtu.be/7UxBYK2AuJQ)\]  
...
*Wolfgang Pieb*  
\[[Slides\] \[](http://llvm.org/devmtg/2017-10/slides/Pieb-Debugging%20of%20optimized%20code.pdf)[Video](https://youtu.be/jf4WR_r2Wok)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Agarwal-Enabling%20Polyhedral%20optimizations%20in%20TensorFlow%20through%20Polly.pdf)\] \[[Video](https://youtu.be/uq67__tfdtQ)\]  
...
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Jain-LLVM%20based%20Loop%20Profiler.pdf)\] \[[Video](https://youtu.be/MKhXpRNekaM)\]  
...
*Petr Hosek*  
\[[Slides](http://llvm.org/devmtg/2017-10/slides/Hosek-Compiling%20cross-toolchains%20with%20CMake%20and%20runtimes%20build.pdf)\] \[[Video](https://youtu.be/OCQGpUzXDsY)\]  
...
\[Slides\] \[[Video](https://youtu.be/svMEphbFukw)\]  
...
\[Slides\] \[[Video](https://youtu.be/xSA0XLYJ-G0)\]  
...
\[Slides\] \[[Video](https://youtu.be/9fdFbVBUQGs)\]  
...
![](logos/quic-stack-version.jpg) [QuIC](http://www.quicinc.com/)
...
![](logos/Mentor-ASB-Logo-Black-Hires.png) [Mentor](https://www.mentor.com)  
