...
*   **Conference Dates**: April 15-16, 2025 (Pre-Conference workshops April 14)
*   **Location**: [InterContinental Berlin, Berlin, Germany](https://www.berlin.intercontinental.com/)
*   **Event Site: [https://llvm.swoogo.com/2025eurollvm/home](https://llvm.swoogo.com/2025eurollvm/home)
    ...
    To see the agenda and speakers please visit the Event Site here: [https://llvm.swoogo.com/2025eurollvm](https://llvm.swoogo.com/2025eurollvm)
    ...
    **Keynotes**
    ...
    Title: A Recipe for Eliminating Entire Classes of Memory Safety Vulnerabilities in C and C++ \[ [Video](https://youtu.be/rYOCPBUM1Hs) \] \[ [Slides](slides/keynote/coughlin_memory.pdf) \]  
    ...
    Title: Deep Dive into the MLIR to LLVM IR Translation Mechanism \[ [Video](https://youtu.be/hkgWi0oN_L8) \] \[ [Slides](slides/keynote/zinenko_deep_dive.pdf) \]  
    ...
    **Technical Talks**
    ...
    Title: berlin: symbol lookup error: libeurollvm.so.2025: undefined symbol: \_Z11abiBreakingChange \[ [Video](https://youtu.be/u1X-l-1Gfv0) \] \[ [Slides](slides/technical_talk/daniel_lookup.pdf) \]  
    ...
    Title: Integration of LLVM-JIT Compiler with Interpreter and manually prepared machine code snippets \[ [Video](https://youtu.be/5vQs4NJB11k) \] \[ [Slides](slides/technical_talk/auberer_integration.pdf) \]  
    ...
    Title: Debugging Regressions: Interactive Differential Debugging \[ [Video](https://youtu.be/sI-jxB0tGpM) \] \[ [Slides](slides/technical_talk/cariappa_debugging.pdf) \]  
    ...
    Title: How to bring your Neural Network into Upstream MLIR Dialects \[ [Video](https://youtu.be/Uzct1s22BSU) \] \[ [Slides](slides/technical_talk/bartel_upstream.pdf) \]  
    ...
    Title: TK Wave: A Symbolic Python/MLIR DSL and Compiler for High Performance Machine Learning \[ [Video](https://youtu.be/TKMWJ3oh85E) \] \[ [Slides](slides/technical_talk/butygin_tk_wave.pdf) \]  
    ...
    Title: llvmlite: A python gym for LLVM \[ [Video](https://youtu.be/IkFun9QzrsE) \] \[ [Slides](slides/technical_talk/singh_llvmlite.pdf) \]  
    ...
    Title: Making LoopAccessAnalysis more precise \[ [Video](https://youtu.be/2Gs-eAKuoXQ) \] \[ [Slides](slides/technical_talk/ramachandra_loopaccessanalysis.pdf) \]  
    ...
    Title: C++ interoperability with memory-safe languages \[ [Video](https://youtu.be/AVmgL-97kqo) \] \[ [Slides](slides/technical_talk/horvath_cplusplus.pdf) \]  
    ...
    Title: Canonicalization in MLIR - Uniqueness and Equivalence \[ [Video](https://youtu.be/929JVLlbtRU) \] \[ [Slides](slides/technical_talk/absar_canonicalization.pdf) \]  
    Speaker: Javed Absar  
    ...
    Title: Solving Compiler Puzzles: Debug Methods in MLIR \[ [Video](https://youtu.be/iyfW6uIRtTU) \] \[ [Slides](slides/technical_talk/mcgirr_solving_compiler_puzzlespdf.pdf) \]  
    ...
    Title: Function multi-versioning: compiler aided function specialization with runtime dispatch. \[ [Video](https://youtu.be/k54MFimPz-A) \] \[ [Slides](slides/technical_talk/lamprineas_function_multi-versioning.pdf) \]  
    ...
    Title: Bringing NVIDIA Blackwell support to LLVM and MLIR \[ [Video](https://youtu.be/qavOwgaieIo) \] \[ [Slides](slides/technical_talk/ozen_blackwell.pdf) \]  
    ...
    Title: Pass Plugins: Past, Present and Future \[ [Video](https://youtu.be/pHfYFGVFczs) \] \[ [Slides](slides/technical_talk/graenitz_pass_plugins.pdf) \]  
    ...
    Title: Parallelizing the LLVM Pipeline with MCLink \[ [Video](https://youtu.be/6Ro6XTHAffY) \] \[ [Slides](slides/technical_talk/chen_parallelizing.pdf) \]  
    Speaker: Weiwei Chen  
    ...
    Title: Devise Loop Distribution with Scalar Expansion for Enhancing Auto-Vectorization in LLVM \[ [Video](https://youtu.be/YtTLpnK9dE8) \] \[ [Slides](slides/technical_talk/lai_loop_distribution.pdf) \]  
    ...
    Title: How to trust your peephole rewrites: automatically verifying them for arbitrary width! \[ [Video](https://youtu.be/WtsInfbzxjs) \] \[ [Slides](slides/technical_talk/bhat_peephole.pdf) \]  
    Speaker: Siddharth Bhat  
    Abstract: We develop algorithms to prove peephole optimzations correct in a bitwidth-generic fashion, and apply it to hacker's delight, rewrites mined from InstCombine, and challenging problems from program deobfuscation. We explain the core ideas of the algorithm, as well as the implementation, evaluation, and proofs which we performed in the Lean proof assistant. Finally, we demo the interface to the end-user, which provides a command (bv\_automata) to prove theorems about bitvector rewrites that are universally quantified over the bitwidth. We hope to use our algorithm to simplify the many thousands of lines of proof in the Lean bitvector standard library, and more broadly, hope to provide effective proof automation for bitvector predicates that quantify over bitwidth.

    Title: Accidental Dataflow Analysis: Extending the RISC-V VL Optimizer \[ [Video](https://youtu.be/Mfb5fRSdJAc) \] \[ [Slides](slides/technical_talk/lau_accidental_dataflow.pdf) \]  
    Speaker: Luke Lau  
    ...
    Title: LLVM IR -- Past, Present and Future \[ [Video](https://youtu.be/gIQEZ3QJz1w) \] \[ [Slides](slides/technical_talk/popov_llvm_ir.pdf) \]  
    ...
    Title: Faster Compilation — Improvements in LLVM 20 and Beyond \[ [Video](https://youtu.be/O1V1N9m35Xo) \] \[ [Slides](slides/technical_talk/engelke_faster.pdf) \]  
    ...
    Title: Bridging LLVM and SPIR-V for Heterogeneous Computing \[ [Video](https://youtu.be/WYPqSVT8QBw) \] \[ [Slides](slides/technical_talk/levytskyy_bridging.pdf) \]  
    ...
    Title: Instrumentor: Easily Customizable Code Instrumentation \[ [Video](https://youtu.be/-BU_pGuiMZc) \] \[ [Slides](slides/technical_talk/sala_instrumentor.pdf) \]  
    ...
    Title: Advances in Function Merging and Symbolication \[ [Video](https://youtu.be/Y-7arpmKfv4) \] \[ [Slides](slides/technical_talk/lee_function_merging.pdf) \]  
    Speakers: Alex Borcan, Kyungwoo Lee  
    Abstract: Optimizing code size is crucial for mobile applications, and function merging is a key technique to achieve this by consolidating identical or similar functions. Recent advancements in global function merging and identical code folding (ICF) at link time have resulted in significant size reductions, with a 3% reduction on top of the state-of-the-art global outliner and affecting 15% of total functions. Additionally, a new safe\_thunks mode has been introduced to improve binary size reduction without compromising runtime safety, achieving an additional 0.45% size savings over regular safe ICF. However, function merging poses challenges for symbolication, which have been addressed through enhancements such as a new DWARF attribute and extended GSYM format support, laying the groundwork for more accurate symbolication in optimized binaries.

    **Tutorials**

    Adopting -fbounds-safety in practice \[ [Video](https://youtu.be/rlevLn831R4) \] \[ [Slides](slides/tutorial/olsonn-stefaniski_fbounds.pdf) \]  
    ...
    Title: How to reduce an llvm bug \[ [Video](https://youtu.be/M5eccFzr_DE) \] \[ [Slides](slides/tutorial/arsenault_reduce.pdf) \]  
    ...
    Title: An Introduction to Tensor Tiling in MLIR \[ [Video](https://youtu.be/FLEb30WyroA) \] \[ [](slides/tutorial/grover_tensor.pdf)Slides \]  
    ...
    **Lightning Talks**
    ...
    What is LLDB-DAP? \[ [Video](https://youtu.be/sfJkf7U2FUg) \] \[ [Slides](slides/lightning_talk/devlieghere_lldb-dap.pdf) \]  
    ...
    Title: sd-visualiser: Interactive graph visualisation for SSA-based IRs \[ [Video](https://youtu.be/fMtGvyWgkXc) \] \[ [Slides](slides/lightning_talk/rice_sd-visualiser.pdf) \]  
    Speaker: Alex Rice  
    ...
    Title: Beyond Pattern-based Optimization: What Can LLM Reshape Auto-vectorization? \[ [Video](https://youtu.be/OLuzmHx0JZ4) \] \[ [Slides](slides/lightning_talk/cheng_beyond_pattern.pdf) \]  
    Speaker: Long Cheng  
    ...
    Title: Why add an IR Reader to the llvm-debuginfo-analyzer tool? \[ [Video](https://youtu.be/jwHgqBPt_Xo) \] \[ [Slides](slides/lightning_talk/alberto_enciso_ir_reader.pdf) \]  
    ...
    Title: To be OR NOT to be \[ [Video](https://youtu.be/82kQW7WEQJw) \] \[ [Slides](slides/lightning_talk/fusik_to_be.pdf) \]  
    Speaker: Piotr Fusik  
    ...
    Title: Accidentally quadratic in compiler-rt/asan \[ [Video](https://youtu.be/S9943zeZN5c) \] \[ [Slides](slides/lightning_talk/pianykh_quadratic.pdf) \]  
    ...
    Title: Dialects as a Dialect: Bringing native C++ registration to IRDL \[ [Video](https://youtu.be/RzkT3ZQN8iI) \] \[ [Slides](slides/lightning_talk/ho_dialects.pdf) \]  
    Speaker: Ivan Ho  
    ...
    Title: Autocheck – Clang-Based Checker for Automotive: Status and Issues \[ [Video](https://youtu.be/ygIFcIFEBHw) \] \[ [Slides](slides/lightning_talk/todorovic_autocheck.pdf) \]  
    ...
    Title: LLDB Statusline \[ [Video](https://youtu.be/BQFwcsN1dJU) \] \[ [Slides](slides/lightning_talk/devlieghere_lldb_statusline.pdf) \]  
    Speaker: Jonas Devlieghere  
    ...
    Title: Defining and verifying MLIR operations with constraints \[ [Video](https://youtu.be/ZU9Lz1Hhnwk) \] \[ [Slides](slides/lightning_talk/rice_constraints.pdf) \]  
    Speaker: Alex Rice  
    ...
    **Quick Talks**
    ...
    Leveraging "nsw" in Flang's LLVM IR Generation for Vectorization \[ [Video](https://youtu.be/n-B-JWanf6g) \] \[ [Slides](slides/quick_talk/minato_nsw.pdf) \]  
    ...
    Title: Instruction Cache Prefetching \[ [Video](https://youtu.be/pA1JHAWplUE) \] \[ [Slides](slides/quick_talk/avraham_prefetching.pdf) \]  
    ...
    Title: #embed in clang: one directive to embed them all \[ [Video](https://youtu.be/AGgVzI6rpN0) \] \[ [Slides](slides/quick_talk/podchishchaeva_embed.pdf) \]  
    ...
    Title: 1:N Dialect Conversion in MLIR \[ [Video](https://youtu.be/UaV1TmqGLfc) \] \[ [Slides](slides/quick_talk/springer_dialect_conversion.pdf) \]  
    ...
    Title: Enhancing Tile & Fuse Transformation in MLIR with a Planning Interface \[ [Video](https://youtu.be/Iv8HBkpHr2c) \] \[ [Slides](slides/quick_talk/cohen_planning_interface.pdf) \]  
    Speaker: Aviad Cohen  
    ...
    Title: LTO/BOLT Optimised Clang/LLD AArch64 toolchain \[ [Video](https://youtu.be/1NEpinve_DY) \] \[ [Slides](slides/quick_talk/yakubova_lto_bolt.pdf) \]  
    ...
    Title: MLIR Tensor Compiler Charter Update \[ [Video](https://youtu.be/mhCs8ARhtSk) \] \[ [Slides](slides/quick_talk/morel_mlir_tensor.pdf) \]  
    Speaker: Rolf Morel  
    ...
    Title: Accurate Runtime Performance Estimation for Predictably Training ML Guided Register Eviction Policies \[ [Video](https://youtu.be/6iQ8q3H3zI0) \] \[ [Slides](slides/quick_talk/grossman_accurate_runtime.pdf) \]  
    ...
    Title: The New Premerge System \[ [Video](https://youtu.be/6iQ8q3H3zI0) \] \[ [Slides](slides/quick_talk/grossman_premerge_system.pdf) \]  
    Speaker: Aiden Grossman  
    ...
    Title: Measuring the health of the LLVM community \[ [Video](https://youtu.be/DmAMrE6lfl4) \] \[ [Slides](slides/quick_talk/bennett_community_health.pdf) \]  
    ...
    Title: Lessons learned from leveling up RISC-V LLVM testing \[ [Video](https://youtu.be/BYwJl181B4M) \] \[ [Slides](slides/quick_talk/bradbury_lessons_learned.pdf) \]  
    ...
    Title: Small Changes, Big Impact: GitHub Workflows for the LLVM Project \[ [Video](https://youtu.be/8AvXA094Io8) \] \[ [Slides](slides/quick_talk/spickett_github_workflows.pdf) \]  
    ...
    **Student Technical Talks:**
    ...
    Clang Static Analyzer: Supporting Multithreaded Code \[ [Video](https://youtu.be/a6lbsWiywuM) \] \[ [Slides](slides/student_technical_talk/nudelman_clang_static.pdf) \]  
    ...
    Title: Integrating XRay into the HPC Tool Ecosystem \[ [Video](https://youtu.be/atUFOPBsxAc) \] \[ [Slides](slides/student_technical_talk/kreutzer_integrating_xray.pdf) \]  
    ...
    Title: Automatic LLVM compiler backend generation with OpenVADL \[ [Video](https://youtu.be/PGE_C70Ddx0) \] \[ [Slides](slides/student_technical_talk/per_openvadl.pdf) \]  
    Speaker: Kevin Per  
    ...
    Title: Pattern Matching, Transform and Code Replacement using LLVM's Polly library \[ [Video](https://youtu.be/wqVUsbaeLlA) \] \[ [Slides](slides/student_technical_talk/huber_pattern_matching.pdf) \]  
    ...
    Title: How to Write a Scalable Compiler for an Error-Prone Quantum Computer \[ [Video](https://youtu.be/e2WhckknJIQ) \] \[ [](slides/student_technical_talk/worrall_quantum.pdf)Slides \]  
    Speaker: Kim Worrall  
    ...
    Title: Optimizing FDTD Solvers for Electromagnetics Using MLIR Across Multiple Hardware Platforms \[ [Video](https://youtu.be/Htr7n5eYQ-E) \] \[ [Slides](slides/student_technical_talk/he_optimizing_fdtd.pdf) \]  
    Speaker: Yifei He  
    ...
    **Posters:**
    ...
    LLVM Support for Sub-FP8 Quantization with RISC-V Extensions for Machine Learning Models \[ [Slides](slides/poster/chapman_sub_fp8.pdf) \]  
    ...
    Title: Towards Multi-Level Arithmetic Optimizations \[ [Slides](slides/poster/ledoux_optimizations.pdf) \]  
    ...
    Title: CuSan: a data race detector for CUDA based on ThreadSanitizer \[ [Slides](slides/poster/hueck_cusan.pdf) \]  
    ...
    Title: SonicMachine: Scalable Architecture Description using MLIR \[ [Slides](slides/poster/khan_sonicmachine.pdf) \]  
    ...
    Title: Coroutines, reinforcement learning environments, typechecking, MLIR: tying them together. \[ [Slides](slides/poster/fioravanti_coroutines.pdf) \]  
    ...
    Title: Code-generation of highly efficient finite element operations using the MLIR compiler infrastructure \[ [Slides](slides/poster/erasmie-jones_ecode.pdf) \]  
